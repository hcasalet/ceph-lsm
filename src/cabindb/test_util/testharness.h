...
#ifdef GTEST_SKIP_
#define CABINDB_GTEST_SKIP(m) GTEST_SKIP_(m)
#else
#define CABINDB_GTEST_SKIP(m) GTEST_SUCCESS_("SKIPPED: " m)
#endif
...
#define ASSERT_OK(s) \
  ASSERT_PRED_FORMAT1(CABINDB_NAMESPACE::test::AssertStatus, s)
#define ASSERT_NOK(s) ASSERT_FALSE((s).ok())
#define EXPECT_OK(s) \
  EXPECT_PRED_FORMAT1(CABINDB_NAMESPACE::test::AssertStatus, s)
