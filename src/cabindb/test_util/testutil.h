...
class FilterNumber : public CompactionFilter {
 public:
  ...
  bool Filter(int /*level*/, const CABINDB_NAMESPACE::Slice& /*key*/,
              const CABINDB_NAMESPACE::Slice& value, std::string* /*new_value*/,
  ...
  bool FilterMergeOperand(
      int /*level*/, const CABINDB_NAMESPACE::Slice& key,
      const CABINDB_NAMESPACE::Slice& value) const override {
