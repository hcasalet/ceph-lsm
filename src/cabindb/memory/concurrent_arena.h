...
// GCC 4.8.1 will fail.
#ifdef __clang__
#define CABINDB_FIELD_UNUSED __attribute__((__unused__))
#else
#define CABINDB_FIELD_UNUSED
#endif  // __clang__
...
class ConcurrentArena : public Allocator {
 ...
 private:
  struct Shard {
    char padding[40] CABINDB_FIELD_UNUSED;
  ...
  char padding0[56] CABINDB_FIELD_UNUSED;
  ...
  char padding1[56] CABINDB_FIELD_UNUSED;
