...
#include "port/port.h"
#include "include/cabindb/memory_allocator.h"
#include "util/thread_local.h"

#if defined(CABINDB_JEMALLOC) && defined(CABINDB_PLATFORM_POSIX)

#include <sys/mman.h>

#if (JEMALLOC_VERSION_MAJOR >= 5) && defined(MADV_DONTDUMP)
#define CABINDB_JEMALLOC_NODUMP_ALLOCATOR
...
#endif  // CABINDB_JEMALLOC && CABINDB_PLATFORM_POSIX
