...
#include "include/cabindb/trace_reader_writer.h"
...
struct TraceStats {
  ...
  std::unique_ptr<CABINDB_NAMESPACE::WritableFile> time_series_f;
  std::unique_ptr<CABINDB_NAMESPACE::WritableFile> a_key_f;
  std::unique_ptr<CABINDB_NAMESPACE::WritableFile> a_count_dist_f;
  std::unique_ptr<CABINDB_NAMESPACE::WritableFile> a_prefix_cut_f;
  std::unique_ptr<CABINDB_NAMESPACE::WritableFile> a_value_size_f;
  std::unique_ptr<CABINDB_NAMESPACE::WritableFile> a_key_size_f;
  std::unique_ptr<CABINDB_NAMESPACE::WritableFile> a_key_num_f;
  std::unique_ptr<CABINDB_NAMESPACE::WritableFile> a_qps_f;
  std::unique_ptr<CABINDB_NAMESPACE::WritableFile> a_top_qps_prefix_f;
  std::unique_ptr<CABINDB_NAMESPACE::WritableFile> w_key_f;
  std::unique_ptr<CABINDB_NAMESPACE::WritableFile> w_prefix_cut_f;
...
class TraceAnalyzer {
 ...
 private:
  ...
  std::unique_ptr<CABINDB_NAMESPACE::WritableFile>
      trace_sequence_f_;                                    // readable trace
  std::unique_ptr<CABINDB_NAMESPACE::WritableFile> qps_f_;  // overall qps
  std::unique_ptr<CABINDB_NAMESPACE::WritableFile>
  ...
  Status CreateOutputFile(
      ...
      std::unique_ptr<CABINDB_NAMESPACE::WritableFile>* f_ptr);
  Status CloseOutputFiles();

  void PrintStatistics();
  Status TraceUnitWriter(
      std::unique_ptr<CABINDB_NAMESPACE::WritableFile>& f_ptr, TraceUnit& unit);
