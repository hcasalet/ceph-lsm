...
// and then iterates over all keys. This is supposed to test CabinDB's abilities
...
// Skip checking for leaked files in CABINDB_LITE since we don't have access to
...
int main(int argc, char** argv) {
  ...
  CABINDB_NAMESPACE::WriteStress write_stress;
