...
class LogStatsParser(TimeSeriesData):
    ...
    def parse_log_line_for_stats(log_line):
        ...
        # "cabindb.db.get.micros P50 : 8.4 P95 : 21.8 P99 : 33.9 P100 : 92.0\n"
        token_list = log_line.strip().split()
        # token_list = ['cabindb.db.get.micros', 'P50', ':', '8.4', 'P95', ':',
        # '21.8', 'P99', ':', '33.9', 'P100', ':', '92.0']
        stat_prefix = token_list[0] + '.'  # 'cabindb.db.get.micros.'
        stat_values = [
            token
        ...
        # stat_dict = {'cabindb.db.get.micros.p50': 8.4,
        # 'cabindb.db.get.micros.p95': 21.8, 'cabindb.db.get.micros.p99': 33.9,
        # 'cabindb.db.get.micros.p100': 92.0}
        return stat_dict
    ...
    def add_to_timeseries(self, log, reqd_stats):
        # this method takes in the Log object that contains the Cabindb stats
        ...
        # Example: reqd_stats = ['cabindb.block.cache.hit.count',
        # 'cabindb.db.get.micros.p99']
        # Let log.get_message() returns following string:
        # "[WARN] [db/db_impl.cc:485] STATISTICS:\n
        # cabindb.block.cache.miss COUNT : 1459\n
        # cabindb.block.cache.hit COUNT : 37\n
        # ...
        # cabindb.db.get.micros P50 : 15.6 P95 : 39.7 P99 : 62.6 P100 : 148.0\n
        # ..."
        new_lines = log.get_message().split('\n')
        # let log_ts = 1532518219
        log_ts = log.get_timestamp()
        # example updates to keys_ts:
        # keys_ts[NO_ENTITY]['cabindb.db.get.micros.p99'][1532518219] = 62.6
        # keys_ts[NO_ENTITY]['cabindb.block.cache.hit.count'][1532518219] = 37
    ...
    def fetch_timeseries(self, reqd_stats):
        # this method parses the Cabindb LOG file and generates timeseries for
