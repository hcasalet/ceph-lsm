...
class DatabaseOptions(DataSource):
    ...
    def is_misc_option(option_name):
        ...
        # Cabindb options file, hence they are not prefixed with any section
        # name
    ...
    def __init__(self, cabindb_options, misc_options=None):
        ...
        self.load_from_source(cabindb_options)
        ...
        # These options are the ones that are not yet supported by the Cabindb
        ...
        with open(options_path, 'r') as db_options:
            for line in db_options:
                ...
                if OptionsSpecParser.is_section_header(line):
                    ...
                    # example: if the line read from the Cabindb OPTIONS file
    ...
    def get_misc_options(self):
        # these are options that are not yet supported by the Cabindb OPTIONS
    ...
    def get_options(self, reqd_options):
        ...
        for option in reqd_options:
            if DatabaseOptions.is_misc_option(option):
                ...
                # not yet supported by the Cabindb OPTIONS file; so it has to
    ...
    def update_options(self, options):
        ...
        for option in options:
            if DatabaseOptions.is_misc_option(option):
                ...
                # supported by the Cabindb OPTIONS file, so it is not prefixed
    ...
    def generate_options_config(self, nonce):
        # this method generates a Cabindb OPTIONS file in the INI format from
