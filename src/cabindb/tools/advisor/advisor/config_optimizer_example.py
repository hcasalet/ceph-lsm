...
def main(args):
    ...
    db_options = DatabaseOptions(args.cabindb_options, args.misc_options)
    ...
    # generate the final cabindb options file
    print(
...
if __name__ == '__main__':
    ...
    --base_db_path=/tmp/cabindbtest-155919/dbbench
    --cabindb_options=temp/OPTIONS_boot.tmp --misc_options bloom_bits=2
