...
class TestDBBenchRunnerMethods(unittest.TestCase):
    ...
    def test_get_info_log_file_name(self):
        ...
        log_file_name = DBBenchRunner.get_info_log_file_name(
            '/dev/shm/', '/tmp/cabindbtest-155919/dbbench/'
        )
        self.assertEqual(log_file_name, 'tmp_cabindbtest-155919_dbbench_LOG')
    ...
    def test_get_log_options(self):
        db_path = '/tmp/cabindb-155919/dbbench'
        ...
        self.assertEqual(
            log_file_prefix, '/dev/shm/tmp_cabindb-155919_dbbench_LOG'
        )
        ...
        self.assertEqual(log_file_prefix, '/tmp/cabindb-155919/dbbench/LOG')
...
class TestDBBenchRunner(unittest.TestCase):
    def setUp(self):
        # Note: the db_bench binary should be present in the cabindb/ directory
        self.pos_args = [
            './../../db_bench',
            'overwrite',
            'use_existing_db=true',
