...
class IOTracerParserTest : public testing::Test {
 public:
  ...
  void RunIOTracerParserTool() {
    ...
    ASSERT_EQ(0, CABINDB_NAMESPACE::io_tracer_parser(argc, argv));
  }
...
TEST_F(IOTracerParserTest, InvalidArguments) {
  {
    ...
    ASSERT_EQ(1, CABINDB_NAMESPACE::io_tracer_parser(argc, argv));
  }
}
...
#include <stdio.h>
int main(int /*argc*/, char** /*argv*/) {
  fprintf(stderr, "io_tracer_parser_test is not supported in CABINDB_LITE\n");
  return 0;
}
#endif  // CABINDB_LITE
