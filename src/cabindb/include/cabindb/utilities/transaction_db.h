...
struct TransactionDBOptions {
  ...
  // txns in mycabin. MyCabin uses merge operands for autoinc column id without
  // however obtaining locks. This breaks the assumption behind the rollback
  // logic in mycabin. This hack of simply not rolling back merge operands works
  // for the special way that mycabin uses this operands.
