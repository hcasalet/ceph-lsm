...
// This file contains utility functions for CabinDB Options.
#pragma once
...
// latest CabinDB options file stored in the specified cabindb database.
//
...
//
// If the return status is non-ok, it means the specified CabinDB instance
