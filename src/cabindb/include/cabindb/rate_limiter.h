...
// Create a RateLimiter object, which can be shared among CabinDB instances to
...
// second. Currently, CabinDB does not enforce rate limit for anything other
...
// CabinDB assigns low-pri to request from compaction and high-pri to request
