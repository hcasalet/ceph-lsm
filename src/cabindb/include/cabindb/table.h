...
//      device.
//   2. Plain table: it is one of CabinDB's SST file format optimized
//      for low query latency on pure-memory or really low-latency media.
//
// A tutorial of cabindb table formats is available here:
//   https://github.com/facebook/cabindb/wiki/A-Tutorial-of-CabinDB-SST-formats
//
// Example code is also available
//   https://github.com/facebook/cabindb/wiki/A-Tutorial-of-CabinDB-SST-formats#wiki-examples
...
struct BlockBasedTableOptions {
  ...
  // If NULL, cabindb will automatically create and use an 8MB internal cache.
  ...
  // If NULL, cabindb will not use a compressed block cache.
  // Note: though it looks similar to `block_cache`, CabinDB doesn't put the
  ...
  // 0 -- This version is currently written out by all CabinDB's versions by
  // default.  Can be read by really old CabinDB's. Doesn't support changing
  // checksum (default is CRC32).
  // 1 -- Can be read by CabinDB's versions since 3.0. Supports non-default
  // checksum, like xxHash. It is written by CabinDB when
  // BlockBasedTableOptions::checksum is something other than kCRC32c. (version
  // 0 is silently upconverted)
  // 2 -- Can be read by CabinDB's versions since 3.10. Changes the way we
  // encode compressed blocks with LZ4, BZip2 and Zlib compression. If you
  // don't plan to run CabinDB before version 3.10, you should probably use
  // this.
  // 3 -- Can be read by CabinDB's versions since 5.15. Changes the way we
  // encode the keys in index blocks. If you don't plan to run CabinDB before
  // version 5.15, you should probably use this.
  // This option only affects newly written tables. When reading existing
  // tables, the information about version is read from the footer.
  // 4 -- Can be read by CabinDB's versions since 5.16. Changes the way we
  ...
  // This option only affects newly written tables. When reading existing
  // tables, the information about version is read from the footer.
  // 5 -- Can be read by CabinDB's versions since 6.6.0. Full and partitioned
