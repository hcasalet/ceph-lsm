...
//
// An Env is an interface used by the cabindb implementation to access
...
#define CABINDB_PRINTF_FORMAT_ATTR(format_param, dots_param) \
...
class Env {
 public:
  ...
  // used in CabinDB internally to update thread status and supports
  // GetThreadList().
...
extern void Log(const InfoLogLevel log_level, Logger* info_log,
                const char* format, ...) CABINDB_PRINTF_FORMAT_ATTR(3, 4);
...
// CABINDB_NAMESPACE::SequentialFileWrapper {
//  public:
//   MySequentialFileWrapper(CABINDB_NAMESPACE::SequentialFile* target):
//     CABINDB_NAMESPACE::SequentialFileWrapper(target) {}
//   Status Read(size_t n, Slice* result, char* scratch) override {
//     cout << "Doing a read of size " << n << "!" << endl;
//     return CABINDB_NAMESPACE::SequentialFileWrapper::Read(n, result,
//     scratch);
//   }
