...
//    into cabindb); numeric addition and string concatenation are examples;
//
...
// more powerful.
//
// Refer to cabindb-merge wiki for more details and example implementations.
//
class MergeOperator {
 public:
  ...
  // https://github.com/facebook/cabindb/issues/3865
