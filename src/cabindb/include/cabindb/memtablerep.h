...
class MemTableRep {
 public:
  ...
  class KeyComparator {
   public:
    typedef CABINDB_NAMESPACE::Slice DecodedType;
  ...
  // of time. Otherwise, CabinDB may be blocked.
...
// This is the base class for all factories that are used by CabinDB to create
