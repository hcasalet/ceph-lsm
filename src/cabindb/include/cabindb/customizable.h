...
/**
 * Customizable a base class used by the cabindb that describes a
 ...
 * implementations of a class for use by CabinDB (e.g. Table, Cache,
...
#endif  // CABINDB_LITE
 protected:
  //  Given a name (e.g. cabindb.my.type.opt), returns the short name (opt)
