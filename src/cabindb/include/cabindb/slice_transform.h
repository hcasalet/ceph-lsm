 ...
 * to another. Its primary use-case is in configuring cabindb
...
class SliceTransform {
 public:
  ...
  // https://github.com/facebook/cabindb/wiki/Prefix-Seek-API-Changes
  //
  ...
  //
  // This function is not used by CabinDB, but for users. If users pass
  // Options by string to CabinDB, they might not know what prefix extractor
