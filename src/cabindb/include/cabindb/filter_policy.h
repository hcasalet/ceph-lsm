...
// of keys.  These filters are stored in cabindb and are consulted
// automatically by cabindb to decide whether or not to read some
...
// CabinDB would first try using functions in Set 2. if they return nullptr,
...
//
// Ribbon filters are ignored by previous versions of CabinDB, as if
// no filter was used.
//
