...
#ifndef CABINDB_PRIszt
#define CABINDB_PRIszt "Iu"
#endif
...
#define CABINDB_NOEXCEPT noexcept
...
#ifdef CABINDB_JEMALLOC
// Separate inlines so they can be replaced if needed
void* jemalloc_aligned_alloc(size_t size, size_t alignment) CABINDB_NOEXCEPT;
void jemalloc_aligned_free(void* p) CABINDB_NOEXCEPT;
#endif
...
#ifdef CABINDB_WINDOWS_UTF8_FILENAMES

#define RX_FILESTRING std::wstring
#define RX_FN(a) CABINDB_NAMESPACE::port::utf8_to_utf16(a)
#define FN_TO_RX(a) CABINDB_NAMESPACE::port::utf16_to_utf8(a)
