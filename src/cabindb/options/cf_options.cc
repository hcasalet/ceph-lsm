...
#include "port/port.h"
#include "include/cabindb/concurrent_task_limiter.h"
...
void MutableCFOptions::Dump(Logger* log) const {
  ...
  CABIN_LOG_INFO(log,
                 "                        write_buffer_size: %" CABINDB_PRIszt,
                 write_buffer_size);
  CABIN_LOG_INFO(log, "                  max_write_buffer_number: %d",
                 max_write_buffer_number);
  CABIN_LOG_INFO(log,
                 "                         arena_block_size: %" CABINDB_PRIszt,
                 arena_block_size);
  CABIN_LOG_INFO(log, "              memtable_prefix_bloom_ratio: %f",
                 memtable_prefix_bloom_size_ratio);
  CABIN_LOG_INFO(log, "              memtable_whole_key_filtering: %d",
                 memtable_whole_key_filtering);
  CABIN_LOG_INFO(log,
                 "                  memtable_huge_page_size: %" CABINDB_PRIszt,
                 memtable_huge_page_size);
  CABIN_LOG_INFO(log,
                 "                    max_successive_merges: %" CABINDB_PRIszt,
                 max_successive_merges);
  CABIN_LOG_INFO(log,
                 "                 inplace_update_num_locks: %" CABINDB_PRIszt,
                 inplace_update_num_locks);
  CABIN_LOG_INFO(
      log, "                         prefix_extractor: %s",
      prefix_extractor == nullptr ? "nullptr" : prefix_extractor->Name());
  CABIN_LOG_INFO(log, "                 disable_auto_compactions: %d",
                 disable_auto_compactions);
  CABIN_LOG_INFO(log, "      soft_pending_compaction_bytes_limit: %" PRIu64,
                 soft_pending_compaction_bytes_limit);
  CABIN_LOG_INFO(log, "      hard_pending_compaction_bytes_limit: %" PRIu64,
                 hard_pending_compaction_bytes_limit);
  CABIN_LOG_INFO(log, "       level0_file_num_compaction_trigger: %d",
                 level0_file_num_compaction_trigger);
  CABIN_LOG_INFO(log, "           level0_slowdown_writes_trigger: %d",
                 level0_slowdown_writes_trigger);
  CABIN_LOG_INFO(log, "               level0_stop_writes_trigger: %d",
                 level0_stop_writes_trigger);
  CABIN_LOG_INFO(log, "                     max_compaction_bytes: %" PRIu64,
                 max_compaction_bytes);
  CABIN_LOG_INFO(log, "                    target_file_size_base: %" PRIu64,
                 target_file_size_base);
  CABIN_LOG_INFO(log, "              target_file_size_multiplier: %d",
                 target_file_size_multiplier);
  CABIN_LOG_INFO(log, "                 max_bytes_for_level_base: %" PRIu64,
                 max_bytes_for_level_base);
  CABIN_LOG_INFO(log, "           max_bytes_for_level_multiplier: %f",
                 max_bytes_for_level_multiplier);
  CABIN_LOG_INFO(log, "                                      ttl: %" PRIu64,
                 ttl);
  CABIN_LOG_INFO(log, "              periodic_compaction_seconds: %" PRIu64,
                 periodic_compaction_seconds);
  std::string result;
  char buf[10];
  ...
  CABIN_LOG_INFO(log, "max_bytes_for_level_multiplier_additional: %s",
                 result.c_str());
  CABIN_LOG_INFO(log, "        max_sequential_skip_in_iterations: %" PRIu64,
                 max_sequential_skip_in_iterations);
  CABIN_LOG_INFO(log, "         check_flush_compaction_key_order: %d",
                 check_flush_compaction_key_order);
  CABIN_LOG_INFO(log, "                     paranoid_file_checks: %d",
                 paranoid_file_checks);
  CABIN_LOG_INFO(log, "                       report_bg_io_stats: %d",
                 report_bg_io_stats);
  CABIN_LOG_INFO(log, "                              compression: %d",
                 static_cast<int>(compression));

  // Universal Compaction Options
  CABIN_LOG_INFO(log, "compaction_options_universal.size_ratio : %d",
                 compaction_options_universal.size_ratio);
  CABIN_LOG_INFO(log, "compaction_options_universal.min_merge_width : %d",
                 compaction_options_universal.min_merge_width);
  CABIN_LOG_INFO(log, "compaction_options_universal.max_merge_width : %d",
  ...
  CABIN_LOG_INFO(log, "compaction_options_universal.stop_style : %d",
  ...
  CABIN_LOG_INFO(log, "compaction_options_fifo.max_table_files_size : %" PRIu64,
                 compaction_options_fifo.max_table_files_size);
  CABIN_LOG_INFO(log, "compaction_options_fifo.allow_compaction : %d",
                 compaction_options_fifo.allow_compaction);

  // Blob file related options
  CABIN_LOG_INFO(log, "                        enable_blob_files: %s",
                 enable_blob_files ? "true" : "false");
  CABIN_LOG_INFO(log, "                            min_blob_size: %" PRIu64,
                 min_blob_size);
  CABIN_LOG_INFO(log, "                           blob_file_size: %" PRIu64,
                 blob_file_size);
  CABIN_LOG_INFO(log, "                    blob_compression_type: %s",
                 CompressionTypeToString(blob_compression_type).c_str());
  CABIN_LOG_INFO(log, "           enable_blob_garbage_collection: %s",
                 enable_blob_garbage_collection ? "true" : "false");
  CABIN_LOG_INFO(log, "       blob_garbage_collection_age_cutoff: %f",
                 blob_garbage_collection_age_cutoff);
}
