...
#if !defined(OS_WIN) && !defined(CABINDB_LITE)
...
//
// GranularLockImpl
// Thread safe custom CabinDB implementation of hash table with granular
// locking
...
int main(int argc, char** argv) {
  ...
  {
    CABINDB_NAMESPACE::SimpleImpl impl;
    CABINDB_NAMESPACE::HashTableBenchmark _(
  ...
  {
    CABINDB_NAMESPACE::GranularLockImpl impl;
    CABINDB_NAMESPACE::HashTableBenchmark _(
        &impl, FLAGS_nsec, FLAGS_nthread_write, FLAGS_nthread_read,
        FLAGS_nthread_erase);
  }
