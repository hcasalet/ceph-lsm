...
int main(int argc, char** argv) {
  ...
  std::unique_ptr<CABINDB_NAMESPACE::CacheTierBenchmark> benchmark(
      new CABINDB_NAMESPACE::CacheTierBenchmark(std::move(cache)));
