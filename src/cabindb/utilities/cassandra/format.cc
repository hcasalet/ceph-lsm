...
void ColumnBase::Serialize(std::string* dest) const {
  CABINDB_NAMESPACE::cassandra::Serialize<int8_t>(mask_, dest);
  CABINDB_NAMESPACE::cassandra::Serialize<int8_t>(index_, dest);
}

std::shared_ptr<ColumnBase> ColumnBase::Deserialize(const char* src,
                                                    std::size_t offset) {
  int8_t mask = CABINDB_NAMESPACE::cassandra::Deserialize<int8_t>(src, offset);
...
void Column::Serialize(std::string* dest) const {
  ...
  CABINDB_NAMESPACE::cassandra::Serialize<int64_t>(timestamp_, dest);
  CABINDB_NAMESPACE::cassandra::Serialize<int32_t>(value_size_, dest);
...
std::shared_ptr<Column> Column::Deserialize(const char *src,
  ...
  int8_t mask = CABINDB_NAMESPACE::cassandra::Deserialize<int8_t>(src, offset);
  offset += sizeof(mask);
  int8_t index = CABINDB_NAMESPACE::cassandra::Deserialize<int8_t>(src, offset);
  offset += sizeof(index);
  int64_t timestamp =
      CABINDB_NAMESPACE::cassandra::Deserialize<int64_t>(src, offset);
  offset += sizeof(timestamp);
  int32_t value_size =
      CABINDB_NAMESPACE::cassandra::Deserialize<int32_t>(src, offset);
...
void ExpiringColumn::Serialize(std::string* dest) const {
  ...
  CABINDB_NAMESPACE::cassandra::Serialize<int32_t>(ttl_, dest);
}
...
std::shared_ptr<ExpiringColumn> ExpiringColumn::Deserialize(
  ...
  offset += value_size;
  int32_t ttl = CABINDB_NAMESPACE::cassandra::Deserialize<int32_t>(src, offset);
...
void Tombstone::Serialize(std::string* dest) const {
  ColumnBase::Serialize(dest);
  CABINDB_NAMESPACE::cassandra::Serialize<int32_t>(local_deletion_time_, dest);
  CABINDB_NAMESPACE::cassandra::Serialize<int64_t>(marked_for_delete_at_, dest);
}
