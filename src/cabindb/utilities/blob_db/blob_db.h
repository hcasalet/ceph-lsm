...
//
// The factory needs to be moved to include/cabindb/utilities to allow
...
class BlobDB : public StackableDB {
 public:
  using CABINDB_NAMESPACE::StackableDB::Put;
  ...
  using CABINDB_NAMESPACE::StackableDB::Delete;
  ...
  using CABINDB_NAMESPACE::StackableDB::Get;
  ...
  using CABINDB_NAMESPACE::StackableDB::MultiGet;
  ...
  using CABINDB_NAMESPACE::StackableDB::SingleDelete;
  ...
  using CABINDB_NAMESPACE::StackableDB::Merge;
  ...
  using CABINDB_NAMESPACE::StackableDB::NewIterator;
  ...
  using CABINDB_NAMESPACE::StackableDB::Close;
