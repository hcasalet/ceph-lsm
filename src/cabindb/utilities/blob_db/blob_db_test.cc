...
TEST_F(BlobDBTest, MigrateFromPlainCabinDB) {
...
// A black-box test for the ttl wrapper around cabindb
...
int main(int /*argc*/, char** /*argv*/) {
  fprintf(stderr, "SKIPPED as BlobDB is not supported in CABINDB_LITE\n");
  return 0;
}
