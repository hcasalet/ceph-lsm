...
// created from CabinDB sstable suffixed name
extern std::string Cabin2LevelTableFileName(const std::string& fullname);
...
// If filename is a cabindb file, store the type of the file in *type.
