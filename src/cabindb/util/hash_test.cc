...
using CABINDB_NAMESPACE::Hash;
using CABINDB_NAMESPACE::Hash64;
using CABINDB_NAMESPACE::Lower32of64;
using CABINDB_NAMESPACE::Slice;
using CABINDB_NAMESPACE::Upper32of64;
...
TEST(HashTest, Hash64LargeValueSchema) {
  ...
  // Note that "1EeRk" is common for "Cabin"
  EXPECT_EQ(
      Hash64TestDescriptor("Cabin", 430),
  ...
  EXPECT_EQ(
      Hash64TestDescriptor("CabinDB", 430),
...
TEST(FastRange64Test, Values) {
  using CABINDB_NAMESPACE::FastRange64;
  // Zero range
...
TEST(FastRangeGenericTest, Values) {
  using CABINDB_NAMESPACE::FastRangeGeneric;
...
uint32_t FastRange32(uint32_t hash, uint32_t range) {
  return CABINDB_NAMESPACE::FastRange32(hash, range);
}

// for inspection of disassembly
size_t FastRange64(uint64_t hash, size_t range) {
  return CABINDB_NAMESPACE::FastRange64(hash, range);
}

// Tests for math.h / math128.h (not worth a separate test binary)
using CABINDB_NAMESPACE::BitParity;
using CABINDB_NAMESPACE::BitsSetToOne;
using CABINDB_NAMESPACE::CountTrailingZeroBits;
using CABINDB_NAMESPACE::DecodeFixed128;
using CABINDB_NAMESPACE::DecodeFixedGeneric;
using CABINDB_NAMESPACE::EncodeFixed128;
using CABINDB_NAMESPACE::EncodeFixedGeneric;
using CABINDB_NAMESPACE::FloorLog2;
using CABINDB_NAMESPACE::Lower64of128;
using CABINDB_NAMESPACE::Multiply64to128;
using CABINDB_NAMESPACE::Unsigned128;
using CABINDB_NAMESPACE::Upper64of128;
...
int main(int argc, char** argv) {
  fprintf(stderr, "NPHash64 id: %x\n",
          static_cast<int>(CABINDB_NAMESPACE::GetSliceNPHash64("CabinDB")));
