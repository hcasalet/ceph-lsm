...
#include <cstdio>
int main() {
  fprintf(stderr, "filter_bench requires gflags and !CABINDB_LITE\n");
  return 1;
}
#else
...
using CABINDB_NAMESPACE::Arena;
using CABINDB_NAMESPACE::BlockContents;
using CABINDB_NAMESPACE::BloomFilterPolicy;
using CABINDB_NAMESPACE::BloomHash;
using CABINDB_NAMESPACE::BuiltinFilterBitsBuilder;
using CABINDB_NAMESPACE::CachableEntry;
using CABINDB_NAMESPACE::EncodeFixed32;
using CABINDB_NAMESPACE::FastRange32;
using CABINDB_NAMESPACE::FilterBitsReader;
using CABINDB_NAMESPACE::FilterBuildingContext;
using CABINDB_NAMESPACE::FullFilterBlockReader;
using CABINDB_NAMESPACE::GetSliceHash;
using CABINDB_NAMESPACE::GetSliceHash64;
using CABINDB_NAMESPACE::Lower32of64;
using CABINDB_NAMESPACE::ParsedFullFilterBlock;
using CABINDB_NAMESPACE::PlainTableBloomV1;
using CABINDB_NAMESPACE::Random32;
using CABINDB_NAMESPACE::Slice;
using CABINDB_NAMESPACE::static_cast_with_check;
using CABINDB_NAMESPACE::StderrLogger;
using CABINDB_NAMESPACE::mock::MockBlockBasedTableTester;
...
#ifdef CABINDB_MALLOC_USABLE_SIZE
    total_memory_used +=
        malloc_usable_size(const_cast<char *>(info.filter_.data()));
#endif  // CABINDB_MALLOC_USABLE_SIZE
        ...
        if (FLAGS_use_plain_table_bloom) {
          ...
          if (dry_run) {
            ...
            may_match = info.full_block_reader_->KeyMayMatch(
                ...
                /*block_offset=*/CABINDB_NAMESPACE::kNotValid,
