...
#define IMPORT_RIBBON_TYPES_AND_SETTINGS(TypesAndSettings)                   \
  ...
  using AddInput = typename CABINDB_NAMESPACE::ribbon::AddInputSelector<     \
...
// preview version 0.7.2 of XXH3 used in CabinDB, a.k.a. XXH3p or Hash64, and
// MurmurHash1 used in CabinDB, a.k.a. Hash.) We say this pre-mixing step
...
#define IMPORT_RIBBON_IMPL_TYPES(TypesAndSettings)                            \
  using Hasher = CABINDB_NAMESPACE::ribbon::StandardHasher<TypesAndSettings>; \
  using Banding =                                                             \
      CABINDB_NAMESPACE::ribbon::StandardBanding<TypesAndSettings>;           \
  using SimpleSoln =                                                          \
      CABINDB_NAMESPACE::ribbon::InMemSimpleSolution<TypesAndSettings>;       \
  using InterleavedSoln =                                                     \
      CABINDB_NAMESPACE::ribbon::SerializableInterleavedSolution<             \
          TypesAndSettings>;                                                  \
