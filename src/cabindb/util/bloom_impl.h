...
// CabinDB. (DynamicBloom is in a separate file for now because it
...
class BloomMath {
 public:
  ...
  static double CacheLocalFpRate(double bits_per_key, int num_probes,
    ...
    // https://github.com/facebook/cabindb/wiki/CabinDB-Bloom-Filter#the-math
...
// https://github.com/facebook/cabindb/issues/4120
//
// DO NOT REUSE
//
