 ...
 public:
  explicit FixedPrefixTransform(size_t prefix_len)
      : prefix_len_(prefix_len),
        ...
        // changes on options_helper in order to make CabinDBOptionsParser work
        // for the new change.
        // TODO(yhchiang): move serialization / deserializaion code inside
        // the class implementation itself.
        name_("cabindb.FixedPrefix." + ToString(prefix_len_)) {}
 ...
 public:
  explicit CappedPrefixTransform(size_t cap_len)
      : cap_len_(cap_len),
        ...
        // TODO(yhchiang): move serialization / deserializaion code inside
        // the class implementation itself.
        name_("cabindb.CappedPrefix." + ToString(cap_len_)) {}
...
class NoopTransform : public SliceTransform {
 public:
  ...
  const char* Name() const override { return "cabindb.Noop"; }
...
// Originally from cabindb/utilities/ldb_cmd.h
