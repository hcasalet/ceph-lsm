...
// that CabinDB uses for SST (static) Bloom filters. (Memtable Bloom filter
// is dynamic.)
//
// Recommended reading:
...
// a "generally good" choice for Ribbon, at least in CabinDB where SST
...
// fragmentation (see optimize_filters_for_memory CabinDB option).
//
