...
// https://github.com/facebook/cabindb/wiki/Cabindb-BlockBasedTable-Format.
...
class BlockBasedTable : public TableReader {
 public:
  ...
  //    are set.
  // @param force_direct_prefetch if true, always prefetching to CabinDB
 ...
 private:
  ...
  // If force_direct_prefetch is true, always prefetching to CabinDB
  //    buffer, rather than calling RandomAccessFile::Prefetch().
...
struct BlockBasedTable::Rep {
  ...
  uint64_t cf_id_for_tracing() const {
    return table_properties
               ...
               : CABINDB_NAMESPACE::TablePropertiesCollectorFactory::Context::
