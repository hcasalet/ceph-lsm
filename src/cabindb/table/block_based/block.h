...
// BlockReadAmpBitmap is a bitmap that map the CABINDB_NAMESPACE::Block data
...
//
// See https://github.com/facebook/cabindb/wiki/Cabindb-BlockBasedTable-Format
 ...
 protected:
  ...
  void SeekForPrevImpl(const Slice&) override {
    ...
    status_ = Status::InvalidArgument(
        "CabinDB internal error: should never call SeekForPrev() on index "
        "blocks");
    raw_key_.Clear();
    value_.clear();
  }
