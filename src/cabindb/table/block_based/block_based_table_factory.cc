...
#include "include/cabindb/flush_block_policy.h"
        ...
        {"read_amp_bytes_per_bit",
         {offsetof(struct BlockBasedTableOptions, read_amp_bytes_per_bit),
          ...
          [](const ConfigOptions& /*opts*/, const std::string& /*name*/,
            ...
            // From 6.15, CabinDB will try to parse the read_amp_bytes_per_bit
...
Status BlockBasedTableFactory::ValidateOptions(
  ...
  if (!BlockBasedTableSupportedVersion(table_options_.format_version)) {
    return Status::InvalidArgument(
        ...
        "include/cabindb/table.h for more info");
  }
...
std::string BlockBasedTableFactory::GetPrintableOptions() const {
  ...
  snprintf(buffer, kBufferSize, "  block_size: %" CABINDB_PRIszt "\n",
...
const std::string BlockBasedTablePropertyNames::kIndexType =
    "cabindb.block.based.table.index.type";
const std::string BlockBasedTablePropertyNames::kWholeKeyFiltering =
    "cabindb.block.based.table.whole.key.filtering";
const std::string BlockBasedTablePropertyNames::kPrefixFiltering =
    "cabindb.block.based.table.prefix.filtering";
const std::string kHashIndexPrefixesBlock = "cabindb.hashindex.prefixes";
const std::string kHashIndexPrefixesMetadataBlock =
    "cabindb.hashindex.metadata";
