...
class ScopedArenaIterator {
  ...
  void reset(InternalIterator* iter) CABINDB_NOEXCEPT {
    if (iter_ != nullptr) {
 ...
 public:
  ...
  ScopedArenaIterator(ScopedArenaIterator&& o) CABINDB_NOEXCEPT {
    iter_ = o.iter_;
    o.iter_ = nullptr;
  }

  ScopedArenaIterator& operator=(ScopedArenaIterator&& o) CABINDB_NOEXCEPT {
    reset(o.iter_);
    o.iter_ = nullptr;
    return *this;
  }
