...
#else
// CABINDB_LITE doesn't have plain table
...
std::string Footer::ToString() const {
  ...
  if (legacy) {
    ...
    result.append("table_magic_number: " +
                  CABINDB_NAMESPACE::ToString(table_magic_number_) + "\n  ");
  } else {
    result.append("checksum: " + CABINDB_NAMESPACE::ToString(checksum_) +
                  "\n  ");
    result.append("metaindex handle: " + metaindex_handle_.ToString() + "\n  ");
    result.append("index handle: " + index_handle_.ToString() + "\n  ");
    result.append("footer version: " + CABINDB_NAMESPACE::ToString(version_) +
                  "\n  ");
    result.append("table_magic_number: " +
                  CABINDB_NAMESPACE::ToString(table_magic_number_) + "\n  ");
  }
