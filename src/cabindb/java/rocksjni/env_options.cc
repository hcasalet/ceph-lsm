...
// calling C++ CABINDB_NAMESPACE::EnvOptions methods
// from Java side.

#include <jni.h>

#include "include/org_cabindb_EnvOptions.h"
#include "cabindb/env.h"

#define ENV_OPTIONS_SET_BOOL(_jhandle, _opt)                          \
  reinterpret_cast<CABINDB_NAMESPACE::EnvOptions *>(_jhandle)->_opt = \
...
/*
 * Class:     org_cabindb_EnvOptions
 * Method:    newEnvOptions
 * Signature: ()J
 */
jlong Java_org_cabindb_EnvOptions_newEnvOptions__(
    JNIEnv*, jclass) {
  auto *env_opt = new CABINDB_NAMESPACE::EnvOptions();
 ...
 * Signature: (J)J
 */
jlong Java_org_cabindb_EnvOptions_newEnvOptions__J(
    JNIEnv*, jclass, jlong jdboptions_handle) {
  auto *db_options =
      reinterpret_cast<CABINDB_NAMESPACE::DBOptions *>(jdboptions_handle);
  auto *env_opt = new CABINDB_NAMESPACE::EnvOptions(*db_options);
  return reinterpret_cast<jlong>(env_opt);
}
 ...
 * Signature: (J)V
 */
void Java_org_cabindb_EnvOptions_disposeInternal(
    JNIEnv*, jobject, jlong jhandle) {
  auto *eo = reinterpret_cast<CABINDB_NAMESPACE::EnvOptions *>(jhandle);
  assert(eo != nullptr);
  delete eo;
}
 ...
 * Signature: (JZ)V
 */
void Java_org_cabindb_EnvOptions_setUseMmapReads(
 ...
 * Signature: (J)Z
 */
jboolean Java_org_cabindb_EnvOptions_useMmapReads(
    JNIEnv*, jobject, jlong jhandle) {
 ...
 * Signature: (JZ)V
 */
void Java_org_cabindb_EnvOptions_setUseMmapWrites(
 ...
 * Signature: (J)Z
 */
jboolean Java_org_cabindb_EnvOptions_useMmapWrites(
    JNIEnv*, jobject, jlong jhandle) {
 ...
 * Signature: (JZ)V
 */
void Java_org_cabindb_EnvOptions_setUseDirectReads(
 ...
 * Signature: (J)Z
 */
jboolean Java_org_cabindb_EnvOptions_useDirectReads(
    JNIEnv*, jobject, jlong jhandle) {
 ...
 * Signature: (JZ)V
 */
void Java_org_cabindb_EnvOptions_setUseDirectWrites(
 ...
 * Signature: (J)Z
 */
jboolean Java_org_cabindb_EnvOptions_useDirectWrites(
    JNIEnv*,  jobject, jlong jhandle) {
 ...
 * Signature: (JZ)V
 */
void Java_org_cabindb_EnvOptions_setAllowFallocate(
 ...
 * Signature: (J)Z
 */
jboolean Java_org_cabindb_EnvOptions_allowFallocate(
    JNIEnv*, jobject, jlong jhandle) {
 ...
 * Signature: (JZ)V
 */
void Java_org_cabindb_EnvOptions_setSetFdCloexec(
 ...
 * Signature: (J)Z
 */
jboolean Java_org_cabindb_EnvOptions_setFdCloexec(
    JNIEnv*, jobject, jlong jhandle) {
 ...
 * Signature: (JJ)V
 */
void Java_org_cabindb_EnvOptions_setBytesPerSync(
 ...
 * Signature: (J)J
 */
jlong Java_org_cabindb_EnvOptions_bytesPerSync(
    JNIEnv*,  jobject,  jlong jhandle) {
 ...
 * Signature: (JZ)V
 */
void Java_org_cabindb_EnvOptions_setFallocateWithKeepSize(
 ...
 * Signature: (J)Z
 */
jboolean Java_org_cabindb_EnvOptions_fallocateWithKeepSize(
    JNIEnv*, jobject, jlong jhandle) {
 ...
 * Signature: (JJ)V
 */
void Java_org_cabindb_EnvOptions_setCompactionReadaheadSize(
 ...
 * Signature: (J)J
 */
jlong Java_org_cabindb_EnvOptions_compactionReadaheadSize(
    JNIEnv*, jobject, jlong jhandle) {
 ...
 * Signature: (JJ)V
 */
void Java_org_cabindb_EnvOptions_setRandomAccessMaxBufferSize(
 ...
 * Signature: (J)J
 */
jlong Java_org_cabindb_EnvOptions_randomAccessMaxBufferSize(
    JNIEnv*, jobject, jlong jhandle) {
 ...
 * Signature: (JJ)V
 */
void Java_org_cabindb_EnvOptions_setWritableFileMaxBufferSize(
 ...
 * Signature: (J)J
 */
jlong Java_org_cabindb_EnvOptions_writableFileMaxBufferSize(
    JNIEnv*, jobject, jlong jhandle) {
 ...
 * Signature: (JJ)V
 */
void Java_org_cabindb_EnvOptions_setRateLimiter(
  ...
  auto *sptr_rate_limiter =
      reinterpret_cast<std::shared_ptr<CABINDB_NAMESPACE::RateLimiter> *>(
          rl_handle);
  auto *env_opt = reinterpret_cast<CABINDB_NAMESPACE::EnvOptions *>(jhandle);
