...
#include "include/org_cabindb_SstFileReaderIterator.h"
#include "cabindb/iterator.h"
#include "cabinjni/portal.h"

/*
 * Class:     org_cabindb_SstFileReaderIterator
 * Method:    disposeInternal
 * Signature: (J)V
 */
void Java_org_cabindb_SstFileReaderIterator_disposeInternal(JNIEnv* /*env*/,
                                                            jobject /*jobj*/,
                                                            jlong handle) {
 ...
 * Signature: (J)Z
 */
jboolean Java_org_cabindb_SstFileReaderIterator_isValid0(JNIEnv* /*env*/,
                                                         jobject /*jobj*/,
                                                         jlong handle) {
 ...
 * Signature: (J)V
 */
void Java_org_cabindb_SstFileReaderIterator_seekToFirst0(JNIEnv* /*env*/,
                                                         jobject /*jobj*/,
                                                         jlong handle) {
 ...
 * Signature: (J)V
 */
void Java_org_cabindb_SstFileReaderIterator_seekToLast0(JNIEnv* /*env*/,
                                                        jobject /*jobj*/,
                                                        jlong handle) {
 ...
 * Signature: (J)V
 */
void Java_org_cabindb_SstFileReaderIterator_next0(JNIEnv* /*env*/,
                                                  jobject /*jobj*/,
                                                  jlong handle) {
 ...
 * Signature: (J)V
 */
void Java_org_cabindb_SstFileReaderIterator_prev0(JNIEnv* /*env*/,
                                                  jobject /*jobj*/,
                                                  jlong handle) {
 ...
 * Signature: (J[BI)V
 */
void Java_org_cabindb_SstFileReaderIterator_seek0(JNIEnv* env, jobject /*jobj*/,
                                                  jlong handle,
                                                  jbyteArray jtarget,
                                                  jint jtarget_len) {
 ...
 * Signature: (J[BI)V
 */
void Java_org_cabindb_SstFileReaderIterator_seekForPrev0(JNIEnv* env,
                                                         jobject /*jobj*/,
                                                         jlong handle,
                                                         jbyteArray jtarget,
                                                         jint jtarget_len) {
 ...
 * Signature: (J)V
 */
void Java_org_cabindb_SstFileReaderIterator_status0(JNIEnv* env,
                                                    jobject /*jobj*/,
                                                    jlong handle) {
  auto* it = reinterpret_cast<CABINDB_NAMESPACE::Iterator*>(handle);
 ...
 * Signature: (J)[B
 */
jbyteArray Java_org_cabindb_SstFileReaderIterator_key0(JNIEnv* env,
                                                       jobject /*jobj*/,
                                                       jlong handle) {
  auto* it = reinterpret_cast<CABINDB_NAMESPACE::Iterator*>(handle);
 ...
 * Signature: (J)[B
 */
jbyteArray Java_org_cabindb_SstFileReaderIterator_value0(JNIEnv* env, jobject /*jobj*/,
                                                         jlong handle) {
  auto* it = reinterpret_cast<CABINDB_NAMESPACE::Iterator*>(handle);
 ...
 */
jint Java_org_cabindb_SstFileReaderIterator_keyDirect0(
 ...
 * Signature: (JLjava/nio/ByteBuffer;II)I
 */
jint Java_org_cabindb_SstFileReaderIterator_valueDirect0(
    JNIEnv* env, jobject /*jobj*/, jlong handle, jobject jtarget,
    jint jtarget_off, jint jtarget_len) {
  auto* it = reinterpret_cast<CABINDB_NAMESPACE::Iterator*>(handle);
  CABINDB_NAMESPACE::Slice value_slice = it->value();
 ...
 */
void Java_org_cabindb_SstFileReaderIterator_seekDirect0(
    JNIEnv* env, jobject /*jobj*/, jlong handle, jobject jtarget,
    jint jtarget_off, jint jtarget_len) {
  auto* it = reinterpret_cast<CABINDB_NAMESPACE::Iterator*>(handle);
 ...
 * Signature: (JLjava/nio/ByteBuffer;II)V
 */
void Java_org_cabindb_SstFileReaderIterator_seekForPrevDirect0(
    JNIEnv* env, jobject /*jobj*/, jlong handle, jobject jtarget,
    jint jtarget_off, jint jtarget_len) {
  auto* it = reinterpret_cast<CABINDB_NAMESPACE::Iterator*>(handle);
 ...
 * Signature: (J)V
 */
void Java_org_cabindb_SstFileReaderIterator_refresh0(JNIEnv* env, jobject /*jobj*/,
                                            jlong handle) {
  auto* it = reinterpret_cast<CABINDB_NAMESPACE::Iterator*>(handle);
