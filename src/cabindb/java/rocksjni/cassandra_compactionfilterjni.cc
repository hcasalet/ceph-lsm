...
#include "include/org_cabindb_CassandraCompactionFilter.h"
#include "utilities/cassandra/cassandra_compaction_filter.h"

/*
 * Class:     org_cabindb_CassandraCompactionFilter
 * Method:    createNewCassandraCompactionFilter0
 * Signature: (ZI)J
 */
jlong Java_org_cabindb_CassandraCompactionFilter_createNewCassandraCompactionFilter0(
    JNIEnv* /*env*/, jclass /*jcls*/, jboolean purge_ttl_on_expiration,
    jint gc_grace_period_in_seconds) {
  auto* compaction_filter =
      new CABINDB_NAMESPACE::cassandra::CassandraCompactionFilter(
