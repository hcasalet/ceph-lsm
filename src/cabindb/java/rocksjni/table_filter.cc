...
#include "include/org_cabindb_AbstractTableFilter.h"
#include "cabinjni/table_filter_jnicallback.h"

/*
 * Class:     org_cabindb_AbstractTableFilter
 * Method:    createNewTableFilter
 * Signature: ()J
 */
jlong Java_org_cabindb_AbstractTableFilter_createNewTableFilter(
    JNIEnv* env, jobject jtable_filter) {
  auto* table_filter_jnicallback =
      new CABINDB_NAMESPACE::TableFilterJniCallback(env, jtable_filter);
