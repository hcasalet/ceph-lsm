...
#include "include/org_cabindb_SstFileManager.h"
#include "cabindb/sst_file_manager.h"
#include "cabinjni/portal.h"

/*
 * Class:     org_cabindb_SstFileManager
 * Method:    newSstFileManager
 * Signature: (JJJDJ)J
 */
jlong Java_org_cabindb_SstFileManager_newSstFileManager(
  ...
  auto* env = reinterpret_cast<CABINDB_NAMESPACE::Env*>(jenv_handle);
  CABINDB_NAMESPACE::Status s;
  CABINDB_NAMESPACE::SstFileManager* sst_file_manager = nullptr;

  if (jlogger_handle != 0) {
    auto* sptr_logger =
        reinterpret_cast<std::shared_ptr<CABINDB_NAMESPACE::Logger>*>(
            jlogger_handle);
    sst_file_manager = CABINDB_NAMESPACE::NewSstFileManager(
  ...
  if (!s.ok()) {
    ...
    CABINDB_NAMESPACE::CabinDBExceptionJni::ThrowNew(jnienv, s);
  }
  auto* sptr_sst_file_manager =
      new std::shared_ptr<CABINDB_NAMESPACE::SstFileManager>(sst_file_manager);
 ...
 * Signature: (JJ)V
 */
void Java_org_cabindb_SstFileManager_setMaxAllowedSpaceUsage(
 ...
 * Signature: (JJ)V
 */
void Java_org_cabindb_SstFileManager_setCompactionBufferSize(
    JNIEnv* /*env*/, jobject /*jobj*/, jlong jhandle,
 ...
 * Signature: (J)Z
 */
jboolean Java_org_cabindb_SstFileManager_isMaxAllowedSpaceReached(
    JNIEnv* /*env*/, jobject /*jobj*/, jlong jhandle) {
  auto* sptr_sst_file_manager =
      reinterpret_cast<std::shared_ptr<CABINDB_NAMESPACE::SstFileManager>*>(
          jhandle);
 ...
 */
jboolean
Java_org_cabindb_SstFileManager_isMaxAllowedSpaceReachedIncludingCompactions(
    JNIEnv* /*env*/, jobject /*jobj*/, jlong jhandle) {
  auto* sptr_sst_file_manager =
      reinterpret_cast<std::shared_ptr<CABINDB_NAMESPACE::SstFileManager>*>(
          jhandle);
 ...
 * Signature: (J)J
 */
jlong Java_org_cabindb_SstFileManager_getTotalSize(JNIEnv* /*env*/,
                                                   jobject /*jobj*/,
                                                   jlong jhandle) {
  auto* sptr_sst_file_manager =
      reinterpret_cast<std::shared_ptr<CABINDB_NAMESPACE::SstFileManager>*>(
 ...
 */
jobject Java_org_cabindb_SstFileManager_getTrackedFiles(JNIEnv* env,
                                                        jobject /*jobj*/,
                                                        jlong jhandle) {
  auto* sptr_sst_file_manager =
      reinterpret_cast<std::shared_ptr<CABINDB_NAMESPACE::SstFileManager>*>(
  ...
  // CABINDB_NAMESPACE::HashMapJni::fromCppMap(env, tracked_files);

  const jobject jtracked_files = CABINDB_NAMESPACE::HashMapJni::construct(
  ...
  const CABINDB_NAMESPACE::HashMapJni::FnMapKV<const std::string,
  ...
  if (!CABINDB_NAMESPACE::HashMapJni::putAll(env, jtracked_files,
                                             tracked_files.begin(),
 ...
 * Signature: (J)J
 */
jlong Java_org_cabindb_SstFileManager_getDeleteRateBytesPerSecond(
    JNIEnv* /*env*/, jobject /*jobj*/, jlong jhandle) {
  auto* sptr_sst_file_manager =
      reinterpret_cast<std::shared_ptr<CABINDB_NAMESPACE::SstFileManager>*>(
          jhandle);
 ...
 * Signature: (JJ)V
 */
void Java_org_cabindb_SstFileManager_setDeleteRateBytesPerSecond(
 ...
 * Signature: (J)D
 */
jdouble Java_org_cabindb_SstFileManager_getMaxTrashDBRatio(JNIEnv* /*env*/,
                                                           jobject /*jobj*/,
                                                           jlong jhandle) {
  auto* sptr_sst_file_manager =
      reinterpret_cast<std::shared_ptr<CABINDB_NAMESPACE::SstFileManager>*>(
 ...
 * Signature: (JD)V
 */
void Java_org_cabindb_SstFileManager_setMaxTrashDBRatio(JNIEnv* /*env*/,
                                                        jobject /*jobj*/,
                                                        jlong jhandle,
                                                        jdouble jratio) {
  auto* sptr_sst_file_manager =
 ...
 * Signature: (J)V
 */
void Java_org_cabindb_SstFileManager_disposeInternal(JNIEnv* /*env*/,
                                                     jobject /*jobj*/,
                                                     jlong jhandle) {
  auto* sptr_sst_file_manager =
      reinterpret_cast<std::shared_ptr<CABINDB_NAMESPACE::SstFileManager>*>(
