...
#ifndef JAVA_CABINJNI_COMPACTION_FILTER_FACTORY_JNICALLBACK_H_
#define JAVA_CABINJNI_COMPACTION_FILTER_FACTORY_JNICALLBACK_H_
...
#endif  // JAVA_CABINJNI_COMPACTION_FILTER_FACTORY_JNICALLBACK_H_
