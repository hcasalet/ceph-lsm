...
#include "include/org_cabindb_Logger.h"
...
void LoggerJniCallback::Logv(const InfoLogLevel log_level, const char* format,
  ...
  if (GetInfoLogLevel() <= log_level) {
    ...
    jobject jlog_level;
    switch (log_level) {
      case CABINDB_NAMESPACE::InfoLogLevel::DEBUG_LEVEL:
        jlog_level = m_jdebug_level;
        break;
      case CABINDB_NAMESPACE::InfoLogLevel::INFO_LEVEL:
        jlog_level = m_jinfo_level;
        break;
      case CABINDB_NAMESPACE::InfoLogLevel::WARN_LEVEL:
        jlog_level = m_jwarn_level;
        break;
      case CABINDB_NAMESPACE::InfoLogLevel::ERROR_LEVEL:
        jlog_level = m_jerror_level;
        break;
      case CABINDB_NAMESPACE::InfoLogLevel::FATAL_LEVEL:
        jlog_level = m_jfatal_level;
        break;
      case CABINDB_NAMESPACE::InfoLogLevel::HEADER_LEVEL:
...
/*
 * Class:     org_cabindb_Logger
 * Method:    createNewLoggerOptions
 * Signature: (J)J
 */
jlong Java_org_cabindb_Logger_createNewLoggerOptions(JNIEnv* env, jobject jobj,
                                                     jlong joptions) {
  auto* sptr_logger = new std::shared_ptr<CABINDB_NAMESPACE::LoggerJniCallback>(
      new CABINDB_NAMESPACE::LoggerJniCallback(env, jobj));

  // set log level
  auto* options = reinterpret_cast<CABINDB_NAMESPACE::Options*>(joptions);
 ...
 * Signature: (J)J
 */
jlong Java_org_cabindb_Logger_createNewLoggerDbOptions(JNIEnv* env,
                                                       jobject jobj,
                                                       jlong jdb_options) {
  auto* sptr_logger = new std::shared_ptr<CABINDB_NAMESPACE::LoggerJniCallback>(
      new CABINDB_NAMESPACE::LoggerJniCallback(env, jobj));
  ...
  // set log level
  auto* db_options =
      reinterpret_cast<CABINDB_NAMESPACE::DBOptions*>(jdb_options);
 ...
 * Signature: (JB)V
 */
void Java_org_cabindb_Logger_setInfoLogLevel(JNIEnv* /*env*/, jobject /*jobj*/,
 ...
 * Signature: (J)B
 */
jbyte Java_org_cabindb_Logger_infoLogLevel(JNIEnv* /*env*/, jobject /*jobj*/,
                                           jlong jhandle) {
  auto* handle =
      reinterpret_cast<std::shared_ptr<CABINDB_NAMESPACE::LoggerJniCallback>*>(
          jhandle);
 ...
 * Signature: (J)V
 */
void Java_org_cabindb_Logger_disposeInternal(JNIEnv* /*env*/, jobject /*jobj*/,
                                             jlong jhandle) {
  auto* handle =
      reinterpret_cast<std::shared_ptr<CABINDB_NAMESPACE::LoggerJniCallback>*>(
          jhandle);
