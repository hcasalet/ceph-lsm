...
// for CABINDB_NAMESPACE::TransactionDB.
...
#include "include/org_cabindb_TransactionDB.h"
...
/*
 * Class:     org_cabindb_TransactionDB
 * Method:    open
 * Signature: (JJLjava/lang/String;)J
 */
jlong Java_org_cabindb_TransactionDB_open__JJLjava_lang_String_2(
  ...
  auto* txn_db_options =
      reinterpret_cast<CABINDB_NAMESPACE::TransactionDBOptions*>(
          jtxn_db_options_handle);
  CABINDB_NAMESPACE::TransactionDB* tdb = nullptr;
  const char* db_path = env->GetStringUTFChars(jdb_path, nullptr);
  if (db_path == nullptr) {
    // exception thrown: OutOfMemoryError
    return 0;
  }
  CABINDB_NAMESPACE::Status s = CABINDB_NAMESPACE::TransactionDB::Open(
 ...
 */
jlongArray Java_org_cabindb_TransactionDB_open__JJLjava_lang_String_2_3_3B_3J(
  ...
  for (int i = 0; i < len_cols; i++) {
    ...
    const CABINDB_NAMESPACE::ColumnFamilyOptions* cf_options =
        reinterpret_cast<CABINDB_NAMESPACE::ColumnFamilyOptions*>(jco[i]);
  ...
  CABINDB_NAMESPACE::TransactionDB* tdb = nullptr;
  const CABINDB_NAMESPACE::Status s = CABINDB_NAMESPACE::TransactionDB::Open(
 ...
 * Signature: (J)V
 */
void Java_org_cabindb_TransactionDB_disposeInternal(
    JNIEnv*, jobject, jlong jhandle) {
  auto* txn_db = reinterpret_cast<CABINDB_NAMESPACE::TransactionDB*>(jhandle);
 ...
 * Signature: (J)V
 */
void Java_org_cabindb_TransactionDB_closeDatabase(
    JNIEnv* env, jclass, jlong jhandle) {
  auto* txn_db = reinterpret_cast<CABINDB_NAMESPACE::TransactionDB*>(jhandle);
  assert(txn_db != nullptr);
  CABINDB_NAMESPACE::Status s = txn_db->Close();
  CABINDB_NAMESPACE::CabinDBExceptionJni::ThrowNew(env, s);
}
 ...
 * Signature: (JJ)J
 */
jlong Java_org_cabindb_TransactionDB_beginTransaction__JJ(
  ...
  CABINDB_NAMESPACE::Transaction* txn =
 ...
 * Signature: (JJJ)J
 */
jlong Java_org_cabindb_TransactionDB_beginTransaction__JJJ(
    JNIEnv*, jobject, jlong jhandle, jlong jwrite_options_handle,
    jlong jtxn_options_handle) {
  auto* txn_db = reinterpret_cast<CABINDB_NAMESPACE::TransactionDB*>(jhandle);
  auto* write_options =
      reinterpret_cast<CABINDB_NAMESPACE::WriteOptions*>(jwrite_options_handle);
  auto* txn_options = reinterpret_cast<CABINDB_NAMESPACE::TransactionOptions*>(
      jtxn_options_handle);
  CABINDB_NAMESPACE::Transaction* txn =
 ...
 * Signature: (JJJ)J
 */
jlong Java_org_cabindb_TransactionDB_beginTransaction_1withOld__JJJ(
    JNIEnv*, jobject, jlong jhandle, jlong jwrite_options_handle,
  ...
  auto* write_options =
      reinterpret_cast<CABINDB_NAMESPACE::WriteOptions*>(jwrite_options_handle);
  auto* old_txn =
      reinterpret_cast<CABINDB_NAMESPACE::Transaction*>(jold_txn_handle);
  CABINDB_NAMESPACE::TransactionOptions txn_options;
  CABINDB_NAMESPACE::Transaction* txn =
      txn_db->BeginTransaction(*write_options, txn_options, old_txn);

  // CabinJava relies on the assumption that
 ...
 * Signature: (JJJJ)J
 */
jlong Java_org_cabindb_TransactionDB_beginTransaction_1withOld__JJJJ(
    JNIEnv*, jobject, jlong jhandle, jlong jwrite_options_handle,
 ...
 */
jlong Java_org_cabindb_TransactionDB_getTransactionByName(
  ...
  CABINDB_NAMESPACE::Transaction* txn = txn_db->GetTransactionByName(name);
 ...
 * Signature: (J)[J
 */
jlongArray Java_org_cabindb_TransactionDB_getAllPreparedTransactions(
    JNIEnv* env, jobject, jlong jhandle) {
  auto* txn_db = reinterpret_cast<CABINDB_NAMESPACE::TransactionDB*>(jhandle);
  std::vector<CABINDB_NAMESPACE::Transaction*> txns;
 ...
 */
jobject Java_org_cabindb_TransactionDB_getLockStatusData(
    JNIEnv* env, jobject, jlong jhandle) {
  auto* txn_db = reinterpret_cast<CABINDB_NAMESPACE::TransactionDB*>(jhandle);
  const std::unordered_multimap<uint32_t, CABINDB_NAMESPACE::KeyLockInfo>
      lock_status_data = txn_db->GetLockStatusData();
  const jobject jlock_status_data = CABINDB_NAMESPACE::HashMapJni::construct(
  ...
  const CABINDB_NAMESPACE::HashMapJni::FnMapKV<
      const int32_t, const CABINDB_NAMESPACE::KeyLockInfo, jobject, jobject>
      fn_map_kv =
          [env](const std::pair<const int32_t,
                                const CABINDB_NAMESPACE::KeyLockInfo>& pair) {
            const jobject jlong_column_family_id =
                CABINDB_NAMESPACE::LongJni::valueOf(env, pair.first);
            if (jlong_column_family_id == nullptr) {
              // an error occurred
              return std::unique_ptr<std::pair<jobject, jobject>>(nullptr);
            }
            const jobject jkey_lock_info =
                CABINDB_NAMESPACE::KeyLockInfoJni::construct(env, pair.second);
 ...
 * Signature: (J)[Lorg/cabindb/TransactionDB/DeadlockPath;
 */
jobjectArray Java_org_cabindb_TransactionDB_getDeadlockInfoBuffer(
    JNIEnv* env, jobject jobj, jlong jhandle) {
  auto* txn_db = reinterpret_cast<CABINDB_NAMESPACE::TransactionDB*>(jhandle);
  const std::vector<CABINDB_NAMESPACE::DeadlockPath> deadlock_info_buffer =
  ...
  jobjectArray jdeadlock_info_buffer = env->NewObjectArray(
      ...
      CABINDB_NAMESPACE::DeadlockPathJni::getJClass(env), nullptr);
  ...
  for (auto buf_it = deadlock_info_buffer.begin(); buf_it != buf_end;
       ++buf_it) {
    const CABINDB_NAMESPACE::DeadlockPath deadlock_path = *buf_it;
    const std::vector<CABINDB_NAMESPACE::DeadlockInfo> deadlock_infos =
        deadlock_path.path;
    const jsize deadlock_infos_len =
        static_cast<jsize>(deadlock_info_buffer.size());
    jobjectArray jdeadlock_infos = env->NewObjectArray(
        deadlock_infos_len, CABINDB_NAMESPACE::DeadlockInfoJni::getJClass(env),
        nullptr);
    ...
    for (auto infos_it = deadlock_infos.begin(); infos_it != infos_end;
         ++infos_it) {
      const CABINDB_NAMESPACE::DeadlockInfo deadlock_info = *infos_it;
      const jobject jdeadlock_info =
          CABINDB_NAMESPACE::TransactionDBJni::newDeadlockInfo(
    ...
    const jobject jdeadlock_path =
        CABINDB_NAMESPACE::DeadlockPathJni::construct(
 ...
 * Signature: (JI)V
 */
void Java_org_cabindb_TransactionDB_setDeadlockInfoBufferSize(
