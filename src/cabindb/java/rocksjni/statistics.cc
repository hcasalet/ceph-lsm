...
// calling c++ CABINDB_NAMESPACE::Statistics methods from Java side.

#include <jni.h>
#include <memory>
#include <set>

#include "include/org_cabindb_Statistics.h"
#include "cabindb/statistics.h"
#include "cabinjni/portal.h"
#include "cabinjni/statisticsjni.h"

/*
 * Class:     org_cabindb_Statistics
 * Method:    newStatistics
 * Signature: ()J
 */
jlong Java_org_cabindb_Statistics_newStatistics__(
    JNIEnv* env, jclass jcls) {
  return Java_org_cabindb_Statistics_newStatistics___3BJ(
      env, jcls, nullptr, 0);
}
 ...
 * Signature: (J)J
 */
jlong Java_org_cabindb_Statistics_newStatistics__J(
 ...
 * Signature: ([B)J
 */
jlong Java_org_cabindb_Statistics_newStatistics___3B(
 ...
 * Signature: ([BJ)J
 */
jlong Java_org_cabindb_Statistics_newStatistics___3BJ(
    JNIEnv* env, jclass, jbyteArray jhistograms, jlong jother_statistics_handle) {
  std::shared_ptr<CABINDB_NAMESPACE::Statistics>* pSptr_other_statistics =
      nullptr;
  if (jother_statistics_handle > 0) {
    pSptr_other_statistics =
        reinterpret_cast<std::shared_ptr<CABINDB_NAMESPACE::Statistics>*>(
  ...
  if (jhistograms != nullptr) {
    ...
    if (len > 0) {
      ...
      for (jsize i = 0; i < len; i++) {
        const CABINDB_NAMESPACE::Histograms histogram =
            CABINDB_NAMESPACE::HistogramTypeJni::toCppHistograms(jhistogram[i]);
  ...
  std::shared_ptr<CABINDB_NAMESPACE::Statistics> sptr_other_statistics =
      nullptr;
  ...
  auto* pSptr_statistics =
      new std::shared_ptr<CABINDB_NAMESPACE::StatisticsJni>(
          new CABINDB_NAMESPACE::StatisticsJni(sptr_other_statistics,
                                               histograms));
 ...
 * Signature: (J)V
 */
void Java_org_cabindb_Statistics_disposeInternal(
 ...
 * Signature: (J)B
 */
jbyte Java_org_cabindb_Statistics_statsLevel(
    JNIEnv*, jobject, jlong jhandle) {
  auto* pSptr_statistics =
      reinterpret_cast<std::shared_ptr<CABINDB_NAMESPACE::Statistics>*>(
          jhandle);
  assert(pSptr_statistics != nullptr);
  return CABINDB_NAMESPACE::StatsLevelJni::toJavaStatsLevel(
 ...
 * Signature: (JB)V
 */
void Java_org_cabindb_Statistics_setStatsLevel(
  ...
  assert(pSptr_statistics != nullptr);
  auto stats_level =
      CABINDB_NAMESPACE::StatsLevelJni::toCppStatsLevel(jstats_level);
 ...
 * Signature: (JB)J
 */
jlong Java_org_cabindb_Statistics_getTickerCount(
    JNIEnv*, jobject, jlong jhandle, jbyte jticker_type) {
  auto* pSptr_statistics =
      reinterpret_cast<std::shared_ptr<CABINDB_NAMESPACE::Statistics>*>(
          jhandle);
  assert(pSptr_statistics != nullptr);
  auto ticker = CABINDB_NAMESPACE::TickerTypeJni::toCppTickers(jticker_type);
 ...
 * Signature: (JB)J
 */
jlong Java_org_cabindb_Statistics_getAndResetTickerCount(
    JNIEnv*, jobject, jlong jhandle, jbyte jticker_type) {
  auto* pSptr_statistics =
      reinterpret_cast<std::shared_ptr<CABINDB_NAMESPACE::Statistics>*>(
          jhandle);
 ...
 * Signature: (JB)Lorg/cabindb/HistogramData;
 */
jobject Java_org_cabindb_Statistics_getHistogramData(
  ...
  CABINDB_NAMESPACE::HistogramData data;

  auto histogram =
      CABINDB_NAMESPACE::HistogramTypeJni::toCppHistograms(jhistogram_type);
  pSptr_statistics->get()->histogramData(
      static_cast<CABINDB_NAMESPACE::Histograms>(histogram), &data);

  jclass jclazz = CABINDB_NAMESPACE::HistogramDataJni::getJClass(env);
  if (jclazz == nullptr) {
  ...
  jmethodID mid =
      CABINDB_NAMESPACE::HistogramDataJni::getConstructorMethodId(env);
  if (mid == nullptr) {
 ...
 */
jstring Java_org_cabindb_Statistics_getHistogramString(
    JNIEnv* env, jobject, jlong jhandle, jbyte jhistogram_type) {
  auto* pSptr_statistics =
      reinterpret_cast<std::shared_ptr<CABINDB_NAMESPACE::Statistics>*>(
          jhandle);
 ...
 * Signature: (J)V
 */
void Java_org_cabindb_Statistics_reset(
    JNIEnv* env, jobject, jlong jhandle) {
  auto* pSptr_statistics =
      reinterpret_cast<std::shared_ptr<CABINDB_NAMESPACE::Statistics>*>(
          jhandle);
  assert(pSptr_statistics != nullptr);
  CABINDB_NAMESPACE::Status s = pSptr_statistics->get()->Reset();
  if (!s.ok()) {
 ...
 */
jstring Java_org_cabindb_Statistics_toString(
    JNIEnv* env, jobject, jlong jhandle) {
  auto* pSptr_statistics =
      reinterpret_cast<std::shared_ptr<CABINDB_NAMESPACE::Statistics>*>(
          jhandle);
