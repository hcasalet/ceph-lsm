...
// calling C++ CABINDB_NAMESPACE::BackupEngine methods from the Java side.

#include <jni.h>
#include <vector>

#include "include/org_cabindb_BackupEngine.h"
#include "cabindb/utilities/backupable_db.h"
#include "cabinjni/portal.h"

/*
 * Class:     org_cabindb_BackupEngine
 * Method:    open
 * Signature: (JJ)J
 */
jlong Java_org_cabindb_BackupEngine_open(JNIEnv* env, jclass /*jcls*/,
                                         jlong env_handle,
                                         jlong backupable_db_options_handle) {
  auto* cabin_env = reinterpret_cast<CABINDB_NAMESPACE::Env*>(env_handle);
  auto* backupable_db_options =
      reinterpret_cast<CABINDB_NAMESPACE::BackupableDBOptions*>(
          backupable_db_options_handle);
  CABINDB_NAMESPACE::BackupEngine* backup_engine;
  auto status = CABINDB_NAMESPACE::BackupEngine::Open(
      cabin_env, *backupable_db_options, &backup_engine);
 ...
 * Signature: (JJZ)V
 */
void Java_org_cabindb_BackupEngine_createNewBackup(
  ...
  auto* backup_engine =
      reinterpret_cast<CABINDB_NAMESPACE::BackupEngine*>(jbe_handle);
 ...
 */
void Java_org_cabindb_BackupEngine_createNewBackupWithMetadata(
    JNIEnv* env, jobject /*jbe*/, jlong jbe_handle, jlong db_handle,
  ...
  std::string app_metadata = CABINDB_NAMESPACE::JniUtil::copyStdString(
 ...
 */
jobject Java_org_cabindb_BackupEngine_getBackupInfo(JNIEnv* env,
                                                    jobject /*jbe*/,
                                                    jlong jbe_handle) {
  auto* backup_engine =
      reinterpret_cast<CABINDB_NAMESPACE::BackupEngine*>(jbe_handle);
  std::vector<CABINDB_NAMESPACE::BackupInfo> backup_infos;
  backup_engine->GetBackupInfo(&backup_infos);
  return CABINDB_NAMESPACE::BackupInfoListJni::getBackupInfo(env, backup_infos);
}
 ...
 * Signature: (J)[I
 */
jintArray Java_org_cabindb_BackupEngine_getCorruptedBackups(JNIEnv* env,
                                                            jobject /*jbe*/,
                                                            jlong jbe_handle) {
  auto* backup_engine =
      reinterpret_cast<CABINDB_NAMESPACE::BackupEngine*>(jbe_handle);
  std::vector<CABINDB_NAMESPACE::BackupID> backup_ids;
 ...
 * Signature: (J)V
 */
void Java_org_cabindb_BackupEngine_garbageCollect(JNIEnv* env, jobject /*jbe*/,
                                                  jlong jbe_handle) {
  auto* backup_engine =
      reinterpret_cast<CABINDB_NAMESPACE::BackupEngine*>(jbe_handle);
 ...
 * Signature: (JI)V
 */
void Java_org_cabindb_BackupEngine_purgeOldBackups(JNIEnv* env, jobject /*jbe*/,
                                                   jlong jbe_handle,
 ...
 * Signature: (JI)V
 */
void Java_org_cabindb_BackupEngine_deleteBackup(JNIEnv* env, jobject /*jbe*/,
                                                jlong jbe_handle,
                                                jint jbackup_id) {
  auto* backup_engine =
      reinterpret_cast<CABINDB_NAMESPACE::BackupEngine*>(jbe_handle);
  auto status = backup_engine->DeleteBackup(
      static_cast<CABINDB_NAMESPACE::BackupID>(jbackup_id));
 ...
 */
void Java_org_cabindb_BackupEngine_restoreDbFromBackup(
  ...
  auto* restore_options = reinterpret_cast<CABINDB_NAMESPACE::RestoreOptions*>(
      jrestore_options_handle);
  auto status = backup_engine->RestoreDBFromBackup(
      static_cast<CABINDB_NAMESPACE::BackupID>(jbackup_id), db_dir, wal_dir,
      *restore_options);
 ...
 */
void Java_org_cabindb_BackupEngine_restoreDbFromLatestBackup(
 ...
 * Signature: (J)V
 */
void Java_org_cabindb_BackupEngine_disposeInternal(JNIEnv* /*env*/,
                                                   jobject /*jbe*/,
                                                   jlong jbe_handle) {
  auto* be = reinterpret_cast<CABINDB_NAMESPACE::BackupEngine*>(jbe_handle);
  assert(be != nullptr);
  delete be;
}
