...
#include "include/org_cabindb_CabinCallbackObject.h"
#include "jnicallback.h"

/*
 * Class:     org_cabindb_CabinCallbackObject
 * Method:    disposeInternal
 * Signature: (J)V
 */
void Java_org_cabindb_CabinCallbackObject_disposeInternal(JNIEnv* /*env*/,
                                                          jobject /*jobj*/,
                                                          jlong handle) {
  ...
  // destructors...
  delete reinterpret_cast<CABINDB_NAMESPACE::JniCallback*>(handle);
}
