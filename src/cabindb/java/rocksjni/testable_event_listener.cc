...
#include "include/org_cabindb_test_TestableEventListener.h"
#include "cabindb/listener.h"
#include "cabindb/status.h"
#include "cabindb/table_properties.h"

using namespace CABINDB_NAMESPACE;
...
/*
 * Class:     org_cabindb_test_TestableEventListener
 * Method:    invokeAllCallbacks
 * Signature: (J)V
 */
void Java_org_cabindb_test_TestableEventListener_invokeAllCallbacks(
