...
CABINDB_NAMESPACE::Status WriteBatchHandlerJniCallback::PutCF(
  ...
  if(status == nullptr) {
    return CABINDB_NAMESPACE::Status::OK();  // TODO(AR) what to do if there is
                                             // an Exception but we don't know
                                             // the CABINDB_NAMESPACE::Status?
  } else {
    return CABINDB_NAMESPACE::Status(*status);
  }
}
...
CABINDB_NAMESPACE::Status WriteBatchHandlerJniCallback::MergeCF(
    uint32_t column_family_id, const Slice& key, const Slice& value) {
...
CABINDB_NAMESPACE::Status WriteBatchHandlerJniCallback::DeleteCF(
...
CABINDB_NAMESPACE::Status WriteBatchHandlerJniCallback::SingleDeleteCF(
    uint32_t column_family_id, const Slice& key) {
...
CABINDB_NAMESPACE::Status WriteBatchHandlerJniCallback::DeleteRangeCF(
...
CABINDB_NAMESPACE::Status WriteBatchHandlerJniCallback::PutBlobIndexCF(
    uint32_t column_family_id, const Slice& key, const Slice& value) {
...
CABINDB_NAMESPACE::Status WriteBatchHandlerJniCallback::MarkBeginPrepare(
    bool unprepare) {
#ifndef DEBUG
  (void) unprepare;
#else
  ...
  // check for Exception, in-particular CabinDBException
  if (m_env->ExceptionCheck()) {
    // exception thrown
    jthrowable exception = m_env->ExceptionOccurred();
    std::unique_ptr<CABINDB_NAMESPACE::Status> status =
        CABINDB_NAMESPACE::CabinDBExceptionJni::toCppStatus(m_env, exception);
    if (status == nullptr) {
      // unkown status or exception occurred extracting status
      m_env->ExceptionDescribe();
      return CABINDB_NAMESPACE::Status::OK();  // TODO(AR) probably need a
  ...
  return CABINDB_NAMESPACE::Status::OK();
}

CABINDB_NAMESPACE::Status WriteBatchHandlerJniCallback::MarkEndPrepare(
    const Slice& xid) {
...
CABINDB_NAMESPACE::Status WriteBatchHandlerJniCallback::MarkNoop(
    bool empty_batch) {
...
CABINDB_NAMESPACE::Status WriteBatchHandlerJniCallback::MarkRollback(
    const Slice& xid) {
...
CABINDB_NAMESPACE::Status WriteBatchHandlerJniCallback::MarkCommit(
    const Slice& xid) {
...
std::unique_ptr<CABINDB_NAMESPACE::Status> WriteBatchHandlerJniCallback::kv_op(
...
std::unique_ptr<CABINDB_NAMESPACE::Status> WriteBatchHandlerJniCallback::k_op(
