...
#include "include/org_cabindb_OptimisticTransactionDB.h"
...
/*
 * Class:     org_cabindb_OptimisticTransactionDB
 * Method:    open
 * Signature: (JLjava/lang/String;)J
 */
jlong Java_org_cabindb_OptimisticTransactionDB_open__JLjava_lang_String_2(
  ...
  CABINDB_NAMESPACE::OptimisticTransactionDB* otdb = nullptr;
  CABINDB_NAMESPACE::Status s =
      CABINDB_NAMESPACE::OptimisticTransactionDB::Open(*options, db_path,
                                                       &otdb);
 ...
 */
jlongArray
Java_org_cabindb_OptimisticTransactionDB_open__JLjava_lang_String_2_3_3B_3J(
  ...
  CABINDB_NAMESPACE::OptimisticTransactionDB* otdb = nullptr;
  const CABINDB_NAMESPACE::Status s =
      CABINDB_NAMESPACE::OptimisticTransactionDB::Open(
 ...
 * Signature: (J)V
 */
void Java_org_cabindb_OptimisticTransactionDB_disposeInternal(
    JNIEnv *, jobject, jlong jhandle) {
  auto* optimistic_txn_db =
      reinterpret_cast<CABINDB_NAMESPACE::OptimisticTransactionDB*>(jhandle);
 ...
 * Signature: (J)V
 */
void Java_org_cabindb_OptimisticTransactionDB_closeDatabase(
    JNIEnv* env, jclass, jlong jhandle) {
  auto* optimistic_txn_db =
      reinterpret_cast<CABINDB_NAMESPACE::OptimisticTransactionDB*>(jhandle);
  assert(optimistic_txn_db != nullptr);
  CABINDB_NAMESPACE::Status s = optimistic_txn_db->Close();
  CABINDB_NAMESPACE::CabinDBExceptionJni::ThrowNew(env, s);
}
 ...
 * Signature: (JJ)J
 */
jlong Java_org_cabindb_OptimisticTransactionDB_beginTransaction__JJ(
 ...
 * Signature: (JJJ)J
 */
jlong Java_org_cabindb_OptimisticTransactionDB_beginTransaction__JJJ(
  ...
  CABINDB_NAMESPACE::Transaction* txn = optimistic_txn_db->BeginTransaction(
 ...
 * Signature: (JJJ)J
 */
jlong Java_org_cabindb_OptimisticTransactionDB_beginTransaction_1withOld__JJJ(
    JNIEnv*, jobject, jlong jhandle, jlong jwrite_options_handle,
  ...
  CABINDB_NAMESPACE::OptimisticTransactionOptions optimistic_txn_options;
  CABINDB_NAMESPACE::Transaction* txn = optimistic_txn_db->BeginTransaction(
 ...
 * Signature: (JJJJ)J
 */
jlong Java_org_cabindb_OptimisticTransactionDB_beginTransaction_1withOld__JJJJ(
    JNIEnv*, jobject, jlong jhandle, jlong jwrite_options_handle,
 ...
 * Signature: (J)J
 */
jlong Java_org_cabindb_OptimisticTransactionDB_getBaseDB(
    JNIEnv*, jobject, jlong jhandle) {
  auto* optimistic_txn_db =
      reinterpret_cast<CABINDB_NAMESPACE::OptimisticTransactionDB*>(jhandle);
