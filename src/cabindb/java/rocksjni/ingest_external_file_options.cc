...
#include "include/org_cabindb_IngestExternalFileOptions.h"
#include "cabindb/options.h"

/*
 * Class:     org_cabindb_IngestExternalFileOptions
 * Method:    newIngestExternalFileOptions
 * Signature: ()J
 */
jlong Java_org_cabindb_IngestExternalFileOptions_newIngestExternalFileOptions__(
    JNIEnv*, jclass) {
  auto* options = new CABINDB_NAMESPACE::IngestExternalFileOptions();
 ...
 * Signature: (ZZZZ)J
 */
jlong Java_org_cabindb_IngestExternalFileOptions_newIngestExternalFileOptions__ZZZZ(
 ...
 * Signature: (J)Z
 */
jboolean Java_org_cabindb_IngestExternalFileOptions_moveFiles(
    JNIEnv*, jobject, jlong jhandle) {
  auto* options =
      reinterpret_cast<CABINDB_NAMESPACE::IngestExternalFileOptions*>(jhandle);
 ...
 * Signature: (JZ)V
 */
void Java_org_cabindb_IngestExternalFileOptions_setMoveFiles(
 ...
 * Signature: (J)Z
 */
jboolean Java_org_cabindb_IngestExternalFileOptions_snapshotConsistency(
    JNIEnv*, jobject, jlong jhandle) {
  auto* options =
      reinterpret_cast<CABINDB_NAMESPACE::IngestExternalFileOptions*>(jhandle);
 ...
 * Signature: (JZ)V
 */
void Java_org_cabindb_IngestExternalFileOptions_setSnapshotConsistency(
 ...
 * Signature: (J)Z
 */
jboolean Java_org_cabindb_IngestExternalFileOptions_allowGlobalSeqNo(
    JNIEnv*, jobject, jlong jhandle) {
  auto* options =
      reinterpret_cast<CABINDB_NAMESPACE::IngestExternalFileOptions*>(jhandle);
 ...
 * Signature: (JZ)V
 */
void Java_org_cabindb_IngestExternalFileOptions_setAllowGlobalSeqNo(
 ...
 * Signature: (J)Z
 */
jboolean Java_org_cabindb_IngestExternalFileOptions_allowBlockingFlush(
    JNIEnv*, jobject, jlong jhandle) {
  auto* options =
      reinterpret_cast<CABINDB_NAMESPACE::IngestExternalFileOptions*>(jhandle);
 ...
 * Signature: (JZ)V
 */
void Java_org_cabindb_IngestExternalFileOptions_setAllowBlockingFlush(
 ...
 * Signature: (J)Z
 */
jboolean Java_org_cabindb_IngestExternalFileOptions_ingestBehind(
    JNIEnv*, jobject, jlong jhandle) {
  auto* options =
      reinterpret_cast<CABINDB_NAMESPACE::IngestExternalFileOptions*>(jhandle);
 ...
 * Signature: (JZ)V
 */
void Java_org_cabindb_IngestExternalFileOptions_setIngestBehind(
 ...
 * Signature: (J)Z
 */
JNIEXPORT jboolean JNICALL Java_org_cabindb_IngestExternalFileOptions_writeGlobalSeqno(
    JNIEnv*, jobject, jlong jhandle) {
  auto* options =
      reinterpret_cast<CABINDB_NAMESPACE::IngestExternalFileOptions*>(jhandle);
 ...
 * Signature: (JZ)V
 */
JNIEXPORT void JNICALL Java_org_cabindb_IngestExternalFileOptions_setWriteGlobalSeqno(
 ...
 * Signature: (J)V
 */
void Java_org_cabindb_IngestExternalFileOptions_disposeInternal(
    JNIEnv*, jobject, jlong jhandle) {
  auto* options =
      reinterpret_cast<CABINDB_NAMESPACE::IngestExternalFileOptions*>(jhandle);
  delete options;
