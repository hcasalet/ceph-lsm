...
public class InfoLogLevelTest {
  ...
  @Test
  public void testInfoLogLevel() throws CabinDBException,
      IOException {
  ...
  @Test
  public void testFatalLogLevel() throws CabinDBException,
      IOException {
    ...
    try (final DBOptions dbOptions = new DBOptions().
        setInfoLogLevel(InfoLogLevel.FATAL_LEVEL);
         final Options options = new Options(dbOptions,
             ...
             setCreateIfMissing(true);
         final CabinDB db =
             CabinDB.open(options, dbFolder.getRoot().getAbsolutePath())) {
