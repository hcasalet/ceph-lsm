...
public class StatisticsTest {
  ...
  @Test
  public void statsLevel() throws CabinDBException {
  ...
  @Test
  public void getTickerCount() throws CabinDBException {
  ...
  @Test
  public void getAndResetTickerCount() throws CabinDBException {
    try (final Statistics statistics = new Statistics();
         final Options opt = new Options()
             .setStatistics(statistics)
             .setCreateIfMissing(true);
  ...
  @Test
  public void getHistogramData() throws CabinDBException {
    try (final Statistics statistics = new Statistics();
         final Options opt = new Options()
             .setStatistics(statistics)
             .setCreateIfMissing(true);
  ...
  @Test
  public void getHistogramString() throws CabinDBException {
    try (final Statistics statistics = new Statistics();
         final Options opt = new Options()
             .setStatistics(statistics)
             .setCreateIfMissing(true);
  ...
  @Test
  public void reset() throws CabinDBException {
    try (final Statistics statistics = new Statistics();
         final Options opt = new Options()
             .setStatistics(statistics)
             .setCreateIfMissing(true);
  ...
  @Test
  public void ToString() throws CabinDBException {
    try (final Statistics statistics = new Statistics();
         final Options opt = new Options()
             .setStatistics(statistics)
             .setCreateIfMissing(true);
