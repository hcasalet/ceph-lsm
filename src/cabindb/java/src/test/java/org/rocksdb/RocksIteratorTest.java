...
public class CabinIteratorTest {
  ...
  @Test
  public void cabinIterator() throws CabinDBException {
  ...
  @Test
  public void cabinIteratorReleaseAfterCfClose() throws CabinDBException {
    try (final Options options = new Options()
        .setCreateIfMissing(true)
        .setCreateMissingColumnFamilies(true);
         final CabinDB db = CabinDB.open(options,
      ...
      try (final CabinIterator iterator = db.newIterator(cfHandle1)) {
        cfHandle1.close();
      ...
      try (final CabinIterator iterator = db.newIterator(cfHandle2)) {
