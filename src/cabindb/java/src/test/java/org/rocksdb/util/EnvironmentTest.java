...
public class EnvironmentTest {
  ...
  public void mac32() {
    ...
    assertThat(Environment.getJniLibraryExtension()).
        isEqualTo(".jnilib");
    assertThat(Environment.getJniLibraryFileName("cabindb")).
        isEqualTo("libcabindbjni-osx.jnilib");
    assertThat(Environment.getSharedLibraryFileName("cabindb")).
        isEqualTo("libcabindbjni.dylib");
  }
  ...
  public void nix32() {
    ...
    assertThat(Environment.getJniLibraryExtension()).
        isEqualTo(".so");
    assertThat(Environment.getJniLibraryFileName("cabindb")).
        isEqualTo("libcabindbjni-linux32.so");
    assertThat(Environment.getSharedLibraryFileName("cabindb")).
        isEqualTo("libcabindbjni.so");
    ...
    assertThat(Environment.getJniLibraryExtension()).
        isEqualTo(".so");
    assertThat(Environment.getJniLibraryFileName("cabindb")).
        isEqualTo("libcabindbjni-linux32-musl.so");
    assertThat(Environment.getSharedLibraryFileName("cabindb")).
        isEqualTo("libcabindbjni.so");
    // UNIX
    setEnvironmentClassField(MUSL_LIBC_FIELD_NAME, false);
  ...
  public void aix32() {
    ...
    assertThat(Environment.getJniLibraryExtension()).
        isEqualTo(".so");
    Environment.getJniLibraryFileName("cabindb");
  }
  ...
  public void nix64() {
    ...
    assertThat(Environment.getJniLibraryExtension()).
        isEqualTo(".so");
    assertThat(Environment.getJniLibraryFileName("cabindb")).
        isEqualTo("libcabindbjni-linux64.so");
    assertThat(Environment.getSharedLibraryFileName("cabindb")).
        isEqualTo("libcabindbjni.so");
    // Linux musl-libc (Alpine)
    setEnvironmentClassField(MUSL_LIBC_FIELD_NAME, true);
    ...
    assertThat(Environment.getJniLibraryExtension()).
        isEqualTo(".so");
    assertThat(Environment.getJniLibraryFileName("cabindb")).
        isEqualTo("libcabindbjni-linux64-musl.so");
    assertThat(Environment.getSharedLibraryFileName("cabindb")).
        isEqualTo("libcabindbjni.so");
    // UNIX
    setEnvironmentClassField(MUSL_LIBC_FIELD_NAME, false);
    ...
    assertThat(Environment.getJniLibraryExtension()).
        isEqualTo(".so");
    assertThat(Environment.getJniLibraryFileName("cabindb")).
        isEqualTo("libcabindbjni-aix64.so");
    assertThat(Environment.getSharedLibraryFileName("cabindb")).
        isEqualTo("libcabindbjni.so");
  }
  ...
  public void win64() {
    ...
    assertThat(Environment.getJniLibraryExtension()).
      isEqualTo(".dll");
    assertThat(Environment.getJniLibraryFileName("cabindb")).
      isEqualTo("libcabindbjni-win64.dll");
    assertThat(Environment.getSharedLibraryFileName("cabindb")).
      isEqualTo("libcabindbjni.dll");
  }
  ...
  public void ppc64le() {
    ...
    assertThat(Environment.getSharedLibraryName("cabindb")).isEqualTo("cabindbjni");
    assertThat(Environment.getJniLibraryName("cabindb")).isEqualTo("cabindbjni-linux-ppc64le");
    assertThat(Environment.getJniLibraryFileName("cabindb"))
        .isEqualTo("libcabindbjni-linux-ppc64le.so");
    assertThat(Environment.getSharedLibraryFileName("cabindb")).isEqualTo("libcabindbjni.so");
    // Linux musl-libc (Alpine)
    setEnvironmentClassField(MUSL_LIBC_FIELD_NAME, true);
    setEnvironmentClassFields("Linux", "ppc64le");
    assertThat(Environment.isUnix()).isTrue();
    ...
    assertThat(Environment.getJniLibraryExtension()).isEqualTo(".so");
    assertThat(Environment.getSharedLibraryName("cabindb")).isEqualTo("cabindbjni");
    assertThat(Environment.getJniLibraryName("cabindb")).isEqualTo("cabindbjni-linux-ppc64le-musl");
    assertThat(Environment.getJniLibraryFileName("cabindb"))
        .isEqualTo("libcabindbjni-linux-ppc64le-musl.so");
    assertThat(Environment.getSharedLibraryFileName("cabindb")).isEqualTo("libcabindbjni.so");
    setEnvironmentClassField(MUSL_LIBC_FIELD_NAME, false);
  }
  ...
  public void aarch64() {
    ...
    assertThat(Environment.getJniLibraryExtension()).isEqualTo(".so");
    assertThat(Environment.getSharedLibraryName("cabindb")).isEqualTo("cabindbjni");
    assertThat(Environment.getJniLibraryName("cabindb")).isEqualTo("cabindbjni-linux-aarch64");
    assertThat(Environment.getJniLibraryFileName("cabindb"))
        .isEqualTo("libcabindbjni-linux-aarch64.so");
    assertThat(Environment.getSharedLibraryFileName("cabindb")).isEqualTo("libcabindbjni.so");
    // Linux musl-libc (Alpine)
    setEnvironmentClassField(MUSL_LIBC_FIELD_NAME, true);
    setEnvironmentClassFields("Linux", "aarch64");
    ...
    assertThat(Environment.getJniLibraryExtension()).isEqualTo(".so");
    assertThat(Environment.getSharedLibraryName("cabindb")).isEqualTo("cabindbjni");
    assertThat(Environment.getJniLibraryName("cabindb")).isEqualTo("cabindbjni-linux-aarch64-musl");
    assertThat(Environment.getJniLibraryFileName("cabindb"))
        .isEqualTo("libcabindbjni-linux-aarch64-musl.so");
    assertThat(Environment.getSharedLibraryFileName("cabindb")).isEqualTo("libcabindbjni.so");
    setEnvironmentClassField(MUSL_LIBC_FIELD_NAME, false);
  }
