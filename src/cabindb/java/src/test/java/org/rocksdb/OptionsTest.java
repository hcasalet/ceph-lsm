...
public class OptionsTest {
  ...
  @Test
  public void writeBufferSize() throws CabinDBException {
    try (final Options opt = new Options()) {
  ...
  @Test
  public void arenaBlockSize() throws CabinDBException {
    try (final Options opt = new Options()) {
      final long longValue = rand.nextLong();
  ...
  @Test
  public void inplaceUpdateNumLocks() throws CabinDBException {
    try (final Options opt = new Options()) {
      final long longValue = rand.nextLong();
  ...
  @Test
  public void maxSuccessiveMerges() throws CabinDBException {
    try (final Options opt = new Options()) {
      final long longValue = rand.nextLong();
  ...
  @Test
  public void maxLogFileSize() throws CabinDBException {
    try (final Options opt = new Options()) {
      final long longValue = rand.nextLong();
  ...
  @Test
  public void logFileTimeToRoll() throws CabinDBException {
    try (final Options opt = new Options()) {
      final long longValue = rand.nextLong();
  ...
  @Test
  public void keepLogFileNum() throws CabinDBException {
    try (final Options opt = new Options()) {
      final long longValue = rand.nextLong();
  ...
  @Test
  public void recycleLogFileNum() throws CabinDBException {
    try (final Options opt = new Options()) {
      final long longValue = rand.nextLong();
  ...
  @Test
  public void manifestPreallocationSize() throws CabinDBException {
    try (final Options opt = new Options()) {
      final long longValue = rand.nextLong();
  ...
  @Test
  public void setWriteBufferManager() throws CabinDBException {
    try (final Options opt = new Options();
  ...
  @Test
  public void setWriteBufferManagerWithZeroBufferSize() throws CabinDBException {
    try (final Options opt = new Options();
         final Cache cache = new LRUCache(1 * 1024 * 1024);
  ...
  @Test
  public void sstFileManager() throws CabinDBException {
    try (final Options options = new Options();
