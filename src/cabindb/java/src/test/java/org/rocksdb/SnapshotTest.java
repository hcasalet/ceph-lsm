...
public class SnapshotTest {
  ...
  @Test
  public void snapshots() throws CabinDBException {
  ...
  @Test
  public void iteratorWithSnapshot() throws CabinDBException {
    try (final Options options = new Options().setCreateIfMissing(true);
         final CabinDB db = CabinDB.open(options,
             dbFolder.getRoot().getAbsolutePath())) {
      db.put("key".getBytes(), "value".getBytes());
      ...
      try (final Snapshot snapshot = db.getSnapshot();
        ...
        try (final CabinIterator snapshotIterator =
  ...
  @Test
  public void iteratorWithSnapshotOnColumnFamily() throws CabinDBException {
    try (final Options options = new Options()
      ...
      try (final Snapshot snapshot = db.getSnapshot();
        ...
        try (final CabinIterator snapshotIterator = db.newIterator(
