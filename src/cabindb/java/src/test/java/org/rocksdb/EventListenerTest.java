...
import org.cabindb.AbstractEventListener.EnabledEventCallback;
import org.cabindb.test.TestableEventListener;
...
public class EventListenerTest {
  ...
  @Test
  public void onFlushCompleted() throws CabinDBException {
    ...
    final AbstractEventListener onFlushCompletedListener = new AbstractEventListener() {
      @Override
      public void onFlushCompleted(final CabinDB cabinDb, final FlushJobInfo flushJobInfo) {
  ...
  @Test
  public void onFlushBegin() throws CabinDBException {
    final AtomicBoolean wasCbCalled = new AtomicBoolean();
    final AbstractEventListener onFlushBeginListener = new AbstractEventListener() {
      @Override
      public void onFlushBegin(final CabinDB cabinDb, final FlushJobInfo flushJobInfo) {
        assertNotNull(flushJobInfo.getColumnFamilyName());
        assertEquals(FlushReason.MANUAL_FLUSH, flushJobInfo.getFlushReason());
        wasCbCalled.set(true);
      }
  ...
  @Test
  public void onTableFileDeleted() throws CabinDBException, InterruptedException {
    final AtomicBoolean wasCbCalled = new AtomicBoolean();
  ...
  @Test
  public void onCompactionBegin() throws CabinDBException {
    final AtomicBoolean wasCbCalled = new AtomicBoolean();
    final AbstractEventListener onCompactionBeginListener = new AbstractEventListener() {
      @Override
      public void onCompactionBegin(final CabinDB db, final CompactionJobInfo compactionJobInfo) {
  ...
  @Test
  public void onTableFileCreated() throws CabinDBException {
    final AtomicBoolean wasCbCalled = new AtomicBoolean();
  ...
  @Test
  public void onTableFileCreationStarted() throws CabinDBException {
    final AtomicBoolean wasCbCalled = new AtomicBoolean();
  ...
  @Test
  public void onColumnFamilyHandleDeletionStarted() throws CabinDBException {
    final AtomicBoolean wasCbCalled = new AtomicBoolean();
  ...
  @Test
  public void onExternalFileIngested() throws CabinDBException {
    final AtomicBoolean wasCbCalled = new AtomicBoolean();
  ...
  public void testAllCallbacksInvocation() {
    ...
    final CapturingTestableEventListener listener = new CapturingTestableEventListener() {
      @Override
      public void onFlushCompleted(final CabinDB db, final FlushJobInfo flushJobInfo) {
        super.onFlushCompleted(db, flushJobInfo);
        assertEquals(flushJobInfoTestData, flushJobInfo);
      }

      @Override
      public void onFlushBegin(final CabinDB db, final FlushJobInfo flushJobInfo) {
  ...
  private static class CapturingTestableEventListener extends TestableEventListener {
    ...
    @Override
    public void onCompactionCompleted(final CabinDB db, final CompactionJobInfo compactionJobInfo) {
