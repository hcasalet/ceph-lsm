...
public class SecondaryDBTest {
  ...
  @Test
  public void openAsSecondary() throws CabinDBException {
    try (final Options options = new Options().setCreateIfMissing(true);
      ...
      try (final Options secondaryOptions = new Options();
           final CabinDB secondaryDb =
               CabinDB.openAsSecondary(secondaryOptions, dbFolder.getRoot().getAbsolutePath(),
  ...
  @Test
  public void openAsSecondaryColumnFamilies() throws CabinDBException {
