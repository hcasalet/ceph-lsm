...
public class TtlDBTest {
  ...
  @Test
  public void ttlDBOpen() throws CabinDBException, InterruptedException {
  ...
  @Test
  public void ttlDBOpenWithTtl() throws CabinDBException, InterruptedException {
    try (final Options options = new Options().setCreateIfMissing(true).setMaxCompactionBytes(0);
  ...
  @Test
  public void ttlDbOpenWithColumnFamilies() throws CabinDBException,
  ...
  @Test
  public void createTtlColumnFamily() throws CabinDBException,
      InterruptedException {
