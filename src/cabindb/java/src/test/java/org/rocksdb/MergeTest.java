...
public class MergeTest {
  ...
  public void stringOption()
      throws InterruptedException, CabinDBException {
  ...
  public void cFStringOption()
    ...
    try (final ColumnFamilyOptions cfOpt1 = new ColumnFamilyOptions()
      ...
      final List<ColumnFamilyDescriptor> cfDescriptors = Arrays.asList(
          new ColumnFamilyDescriptor(CabinDB.DEFAULT_COLUMN_FAMILY, cfOpt1),
          new ColumnFamilyDescriptor(CabinDB.DEFAULT_COLUMN_FAMILY, cfOpt2)
      );
