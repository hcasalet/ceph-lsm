...
public class LoggerTest {
  ...
  @Test
  public void customLogger() throws CabinDBException {
  ...
  @Test
  public void warnLogger() throws CabinDBException {
    final AtomicInteger logMessageCounter = new AtomicInteger();
    try (final Options options = new Options().
  ...
  @Test
  public void fatalLogger() throws CabinDBException {
    final AtomicInteger logMessageCounter = new AtomicInteger();
    try (final Options options = new Options().
  ...
  @Test
  public void dbOptionsLogger() throws CabinDBException {
    final AtomicInteger logMessageCounter = new AtomicInteger();
  ...
  @Test
  public void changeLogLevelAtRuntime() throws CabinDBException {
    final AtomicInteger logMessageCounter = new AtomicInteger();
    try (final Options options = new Options().
        setInfoLogLevel(InfoLogLevel.FATAL_LEVEL).
        setCreateIfMissing(true);
