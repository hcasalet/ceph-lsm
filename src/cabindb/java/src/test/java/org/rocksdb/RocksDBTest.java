...
public class CabinDBTest {
  ...
  @Test
  public void open() throws CabinDBException {
    try (final CabinDB db =
             CabinDB.open(dbFolder.getRoot().getAbsolutePath())) {
      assertThat(db).isNotNull();
    }
  }

  @Test
  public void open_opt() throws CabinDBException {
    try (final Options opt = new Options().setCreateIfMissing(true);
         final CabinDB db = CabinDB.open(opt,
  ...
  @Test
  public void openWhenOpen() throws CabinDBException {
    final String dbPath = dbFolder.getRoot().getAbsolutePath();

    try (final CabinDB db1 = CabinDB.open(dbPath)) {
      try (final CabinDB db2 = CabinDB.open(dbPath)) {
  ...
  @Test
  public void createColumnFamily() throws CabinDBException {
  ...
  @Test
  public void createColumnFamilies() throws CabinDBException {
    final byte[] col1Name = "col1".getBytes(UTF_8);
  ...
  @Test
  public void createColumnFamiliesfromDescriptors() throws CabinDBException {
    final byte[] col1Name = "col1".getBytes(UTF_8);
    final byte[] col2Name = "col2".getBytes(UTF_8);
  ...
  @Test
  public void put() throws CabinDBException {
    try (final CabinDB db = CabinDB.open(dbFolder.getRoot().getAbsolutePath());
  ...
  @Test
  public void write() throws CabinDBException {
    try (final StringAppendOperator stringAppendOperator = new StringAppendOperator();
         final Options options = new Options()
             .setMergeOperator(stringAppendOperator)
             .setCreateIfMissing(true);
         final CabinDB db = CabinDB.open(options,
             dbFolder.getRoot().getAbsolutePath());
  ...
  @Test
  public void getWithOutValue() throws CabinDBException {
    try (final CabinDB db =
             CabinDB.open(dbFolder.getRoot().getAbsolutePath())) {
      db.put("key1".getBytes(), "value".getBytes());
      ...
      assertThat(getResult).isEqualTo(CabinDB.NOT_FOUND);
      // found value which fits in outValue
      getResult = db.get("key1".getBytes(), outValue);
      assertThat(getResult).isNotEqualTo(CabinDB.NOT_FOUND);
  ...
  @Test
  public void getWithOutValueReadOptions() throws CabinDBException {
    try (final CabinDB db = CabinDB.open(dbFolder.getRoot().getAbsolutePath());
  ...
  @Test
  public void getOutOfArrayMaxSizeValue() throws CabinDBException {
    ...
    thrown.expect(CabinDBException.class);
    ...
    try (final StringAppendOperator stringAppendOperator = new StringAppendOperator();
         final Options opt = new Options()
                 .setCreateIfMissing(true)
                 .setMergeOperator(stringAppendOperator);
         final CabinDB db = CabinDB.open(opt, dbFolder.getRoot().getAbsolutePath())) {
  ...
  @Test
  public void multiGet() throws CabinDBException {
    try (final CabinDB db = CabinDB.open(dbFolder.getRoot().getAbsolutePath());
         final ReadOptions rOpt = new ReadOptions()) {
      db.put("key1".getBytes(), "value".getBytes());
      db.put("key2".getBytes(), "12345678".getBytes());
  ...
  @Test
  public void multiGetAsList() throws CabinDBException {
    try (final CabinDB db = CabinDB.open(dbFolder.getRoot().getAbsolutePath());
         final ReadOptions rOpt = new ReadOptions()) {
      db.put("key1".getBytes(), "value".getBytes());
      db.put("key2".getBytes(), "12345678".getBytes());
  ...
  @Test
  public void merge() throws CabinDBException {
    try (final StringAppendOperator stringAppendOperator = new StringAppendOperator();
         final Options opt = new Options()
            .setCreateIfMissing(true)
            .setMergeOperator(stringAppendOperator);
  ...
  @Test
  public void delete() throws CabinDBException {
    try (final CabinDB db = CabinDB.open(dbFolder.getRoot().getAbsolutePath());
         final WriteOptions wOpt = new WriteOptions()) {
      db.put("key1".getBytes(), "value".getBytes());
      db.put("key2".getBytes(), "12345678".getBytes());
  ...
  @Test
  public void singleDelete() throws CabinDBException {
    try (final CabinDB db = CabinDB.open(dbFolder.getRoot().getAbsolutePath());
         final WriteOptions wOpt = new WriteOptions()) {
      db.put("key1".getBytes(), "value".getBytes());
      db.put("key2".getBytes(), "12345678".getBytes());
  ...
  @Test
  public void singleDelete_nonExisting() throws CabinDBException {
    try (final CabinDB db = CabinDB.open(dbFolder.getRoot().getAbsolutePath());
         final WriteOptions wOpt = new WriteOptions()) {
      db.singleDelete("key1".getBytes());
      db.singleDelete(wOpt, "key2".getBytes());
  ...
  @Test
  public void deleteRange() throws CabinDBException {
    try (final CabinDB db = CabinDB.open(dbFolder.getRoot().getAbsolutePath())) {
      db.put("key1".getBytes(), "value".getBytes());
      db.put("key2".getBytes(), "12345678".getBytes());
  ...
  @Test
  public void getIntProperty() throws CabinDBException {
    try (
        final Options options = new Options()
            .setCreateIfMissing(true)
      ...
      assertThat(db.getLongProperty("cabindb.num-entries-active-mem-table"))
          .isGreaterThan(0);
      assertThat(db.getLongProperty("cabindb.cur-size-active-mem-table"))
          .isGreaterThan(0);
    }
  }

  @Test
  public void fullCompactRange() throws CabinDBException {
  ...
  public void fullCompactRangeColumnFamily()
    ...
    try (
      ...
      try (final CabinDB db = CabinDB.open(opt,
          dbFolder.getRoot().getAbsolutePath(),
  ...
  public void compactRangeToLevel()
      throws CabinDBException, InterruptedException {
    ...
    try (final Options opt = new Options().
      ...
      for (int round = 0; round < 5; ++round) {
        ...
        for (int f = 1; f <= NUM_L0_FILES; ++f) {
          ...
          assertThat(
              db.getProperty("cabindb.num-files-at-level0")).
              isEqualTo("" + f);
        }
        ...
        assertThat(
            db.getProperty("cabindb.num-files-at-level1")).
            isNotEqualTo("0");
        ...
        assertThat(
            db.getProperty("cabindb.num-files-at-level2")).
            isEqualTo("0");
      }
    }
  }
  ...
  @Test
  public void deleteFilesInRange() throws CabinDBException, InterruptedException {
    final int KEY_SIZE = 20;
    ...
    try (final Options opt = new Options()
      ...
      db.compactRange();
      // Make sure we do create one more L0 files.
      assertThat(db.getProperty("cabindb.num-files-at-level0")).isEqualTo("0");

      // Should be 10, but we are OK with asserting +- 2
      int files = Integer.parseInt(db.getProperty("cabindb.num-files-at-level1"));
      ...
      db.deleteFilesInRanges(null,
          ...
          false);
      files = Integer.parseInt(db.getProperty("cabindb.num-files-at-level1"));
  ...
  @Test
  public void continueBackgroundWorkAfterCancelAllBackgroundWork() throws CabinDBException {
    final int KEY_SIZE = 20;
    final int VALUE_SIZE = 300;
    try (final DBOptions opt = new DBOptions().
        setCreateIfMissing(true).
      ...
      try (final CabinDB db = CabinDB.open(opt,
        ...
        try {
          ...
          try {
            ...
            db.flush(new FlushOptions().setWaitForFlush(true));
            fail("Expected CabinDBException to be thrown if we attempt to trigger a flush after" +
                " all background work is cancelled.");
          } catch (CabinDBException ignored) { }
        } finally {
          for (final ColumnFamilyHandle handle : columnFamilyHandles) {
            handle.close();
          }
  ...
  @Test
  public void cancelAllBackgroundWorkTwice() throws CabinDBException {
  ...
  @Test
  public void pauseContinueBackgroundWork() throws CabinDBException {
    try (final Options options = new Options().setCreateIfMissing(true);
         final CabinDB db = CabinDB.open(options,
             dbFolder.getRoot().getAbsolutePath())
    ) {
  ...
  @Test
  public void enableDisableFileDeletions() throws CabinDBException {
    try (final Options options = new Options().setCreateIfMissing(true);
         final CabinDB db = CabinDB.open(options,
             dbFolder.getRoot().getAbsolutePath())
    ) {
  ...
  @Test
  public void setOptions() throws CabinDBException {
  ...
  @Test
  public void destroyDB() throws CabinDBException {
    try (final Options options = new Options().setCreateIfMissing(true)) {
      String dbPath = dbFolder.getRoot().getAbsolutePath();
      try (final CabinDB db = CabinDB.open(options, dbPath)) {
        db.put("key1".getBytes(), "value".getBytes());
      }
      assertThat(dbFolder.getRoot().exists() && dbFolder.getRoot().listFiles().length != 0)
          .isTrue();
      CabinDB.destroyDB(dbPath, options);
      assertThat(dbFolder.getRoot().exists() && dbFolder.getRoot().listFiles().length != 0)
          .isFalse();
    }
  }
  ...
  public void destroyDBFailIfOpen() throws CabinDBException {
    try (final Options options = new Options().setCreateIfMissing(true)) {
      String dbPath = dbFolder.getRoot().getAbsolutePath();
      try (final CabinDB db = CabinDB.open(options, dbPath)) {
  ...
  @Test
  public void getApproximateSizes() throws CabinDBException {
  ...
  @Test
  public void getApproximateMemTableStats() throws CabinDBException {
    final byte key1[] = "key1".getBytes(UTF_8);
    final byte key2[] = "key2".getBytes(UTF_8);
    final byte key3[] = "key3".getBytes(UTF_8);
    try (final Options options = new Options().setCreateIfMissing(true)) {
      ...
      try (final CabinDB db = CabinDB.open(options, dbPath)) {
        ...
        final CabinDB.CountAndSize stats =
  ...
  @Test
  public void compactFiles() throws CabinDBException {
    ...
    try (final Options options = new Options()
      ...
      try (final ColumnFamilyOptions cfOptions = new ColumnFamilyOptions(options)) {
        final List<ColumnFamilyDescriptor> cfDescriptors = Arrays.asList(
            new ColumnFamilyDescriptor(CabinDB.DEFAULT_COLUMN_FAMILY, cfOptions),
            new ColumnFamilyDescriptor(cfName, cfOptions)
        );
        final List<ColumnFamilyHandle> cfHandles = new ArrayList<>();
        try (final DBOptions dbOptions = new DBOptions(options);
            final CabinDB db = CabinDB.open(dbOptions, dbPath, cfDescriptors,
                cfHandles);
        ) {
          try (final FlushOptions flushOptions = new FlushOptions()
            ...
            final CabinDB.LiveFiles liveFiles = db.getLiveFiles();
  ...
  @Test
  public void enableAutoCompaction() throws CabinDBException {
    try (final DBOptions options = new DBOptions()
        .setCreateIfMissing(true)) {
      ...
      final List<ColumnFamilyHandle> cfHandles = new ArrayList<>();
      final String dbPath = dbFolder.getRoot().getAbsolutePath();
      try (final CabinDB db = CabinDB.open(options, dbPath, cfDescs, cfHandles)) {
        try {
  ...
  @Test
  public void numberLevels() throws CabinDBException {
    try (final Options options = new Options().setCreateIfMissing(true)) {
      final String dbPath = dbFolder.getRoot().getAbsolutePath();
      try (final CabinDB db = CabinDB.open(options, dbPath)) {
  ...
  @Test
  public void maxMemCompactionLevel() throws CabinDBException {
    try (final Options options = new Options().setCreateIfMissing(true)) {
      final String dbPath = dbFolder.getRoot().getAbsolutePath();
      try (final CabinDB db = CabinDB.open(options, dbPath)) {
  ...
  @Test
  public void level0StopWriteTrigger() throws CabinDBException {
    try (final Options options = new Options().setCreateIfMissing(true)) {
      final String dbPath = dbFolder.getRoot().getAbsolutePath();
      try (final CabinDB db = CabinDB.open(options, dbPath)) {
  ...
  @Test
  public void getName() throws CabinDBException {
    try (final Options options = new Options().setCreateIfMissing(true)) {
      final String dbPath = dbFolder.getRoot().getAbsolutePath();
      try (final CabinDB db = CabinDB.open(options, dbPath)) {
  ...
  @Test
  public void getEnv() throws CabinDBException {
    try (final Options options = new Options().setCreateIfMissing(true)) {
      final String dbPath = dbFolder.getRoot().getAbsolutePath();
      try (final CabinDB db = CabinDB.open(options, dbPath)) {
  ...
  @Test
  public void flushWal() throws CabinDBException {
    try (final Options options = new Options().setCreateIfMissing(true)) {
      final String dbPath = dbFolder.getRoot().getAbsolutePath();
      try (final CabinDB db = CabinDB.open(options, dbPath)) {
        db.flushWal(true);
  ...
  @Test
  public void setPreserveDeletesSequenceNumber() throws CabinDBException {
    try (final Options options = new Options().setCreateIfMissing(true)) {
      final String dbPath = dbFolder.getRoot().getAbsolutePath();
      try (final CabinDB db = CabinDB.open(options, dbPath)) {
  ...
  @Test
  public void getLiveFiles() throws CabinDBException {
    try (final Options options = new Options().setCreateIfMissing(true)) {
      final String dbPath = dbFolder.getRoot().getAbsolutePath();
      try (final CabinDB db = CabinDB.open(options, dbPath)) {
        final CabinDB.LiveFiles livefiles = db.getLiveFiles(true);
  ...
  @Test
  public void getSortedWalFiles() throws CabinDBException {
    try (final Options options = new Options().setCreateIfMissing(true)) {
      final String dbPath = dbFolder.getRoot().getAbsolutePath();
      try (final CabinDB db = CabinDB.open(options, dbPath)) {
  ...
  @Test
  public void deleteFile() throws CabinDBException {
    try (final Options options = new Options().setCreateIfMissing(true)) {
      final String dbPath = dbFolder.getRoot().getAbsolutePath();
      try (final CabinDB db = CabinDB.open(options, dbPath)) {
  ...
  @Test
  public void getLiveFilesMetaData() throws CabinDBException {
    try (final Options options = new Options().setCreateIfMissing(true)) {
      final String dbPath = dbFolder.getRoot().getAbsolutePath();
      try (final CabinDB db = CabinDB.open(options, dbPath)) {
        db.put("key1".getBytes(UTF_8), "value1".getBytes(UTF_8));
  ...
  @Test
  public void getColumnFamilyMetaData() throws CabinDBException {
    try (final DBOptions options = new DBOptions()
        .setCreateIfMissing(true)) {
      final List<ColumnFamilyDescriptor> cfDescs = Arrays.asList(
          new ColumnFamilyDescriptor(CabinDB.DEFAULT_COLUMN_FAMILY)
      ...
      try (final CabinDB db = CabinDB.open(options, dbPath, cfDescs, cfHandles)) {
        ...
        try {
          ...
          assertThat(cfMetadata.name()).isEqualTo(CabinDB.DEFAULT_COLUMN_FAMILY);
  ...
  @Test
  public void getPropertiesOfAllTables() throws CabinDBException {
    try (final DBOptions options = new DBOptions()
        .setCreateIfMissing(true)) {
      final List<ColumnFamilyDescriptor> cfDescs = Arrays.asList(
          new ColumnFamilyDescriptor(CabinDB.DEFAULT_COLUMN_FAMILY)
  ...
  @Test
  public void getPropertiesOfTablesInRange() throws CabinDBException {
    try (final DBOptions options = new DBOptions()
        .setCreateIfMissing(true)) {
      final List<ColumnFamilyDescriptor> cfDescs = Arrays.asList(
          new ColumnFamilyDescriptor(CabinDB.DEFAULT_COLUMN_FAMILY)
  ...
  @Test
  public void suggestCompactRange() throws CabinDBException {
    try (final DBOptions options = new DBOptions()
        .setCreateIfMissing(true)) {
      final List<ColumnFamilyDescriptor> cfDescs = Arrays.asList(
          new ColumnFamilyDescriptor(CabinDB.DEFAULT_COLUMN_FAMILY)
  ...
  @Test
  public void promoteL0() throws CabinDBException {
    try (final Options options = new Options().setCreateIfMissing(true)) {
      final String dbPath = dbFolder.getRoot().getAbsolutePath();
      try (final CabinDB db = CabinDB.open(options, dbPath)) {
        db.promoteL0(2);
  ...
  @Test
  public void startTrace() throws CabinDBException {
    try (final Options options = new Options().setCreateIfMissing(true)) {
      final String dbPath = dbFolder.getRoot().getAbsolutePath();
      try (final CabinDB db = CabinDB.open(options, dbPath)) {
  ...
  @Test
  public void setDBOptions() throws CabinDBException {
    try (final DBOptions options = new DBOptions()
        .setCreateIfMissing(true)
        .setCreateMissingColumnFamilies(true);
         final ColumnFamilyOptions new_cf_opts = new ColumnFamilyOptions()
  ...
  @Test
  public void cabindbVersion() {
    final CabinDB.Version version = CabinDB.cabindbVersion();
