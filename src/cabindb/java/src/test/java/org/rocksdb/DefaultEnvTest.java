...
public class DefaultEnvTest {
  ...
  public void backgroundThreads() {
    try (final Env defaultEnv = CabinEnv.getDefault()) {
  ...
  @Test
  public void threadList() throws CabinDBException {
    try (final Env defaultEnv = CabinEnv.getDefault()) {
  ...
  @Test
  public void threadList_integration() throws CabinDBException {
    try (final Env env = CabinEnv.getDefault();
