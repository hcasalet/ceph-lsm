...
public class ColumnFamilyTest {
  ...
  @Test
  public void columnFamilyDescriptorName() throws CabinDBException {
  ...
  @Test
  public void columnFamilyDescriptorOptions() throws CabinDBException {
    final byte[] cfName = "some_name".getBytes(UTF_8);
  ...
  @Test
  public void listColumnFamilies() throws CabinDBException {
    try (final Options options = new Options().setCreateIfMissing(true);
         final CabinDB db = CabinDB.open(options,
             dbFolder.getRoot().getAbsolutePath())) {
      // Test listColumnFamilies
      final List<byte[]> columnFamilyNames = CabinDB.listColumnFamilies(options,
          dbFolder.getRoot().getAbsolutePath());
  ...
  @Test
  public void defaultColumnFamily() throws CabinDBException {
    try (final Options options = new Options().setCreateIfMissing(true);
         final CabinDB db = CabinDB.open(options,
             dbFolder.getRoot().getAbsolutePath())) {
  ...
  public void createColumnFamily() throws CabinDBException {
    ...
    try (final Options options = new Options().setCreateIfMissing(true);
      ...
      try {
        ...
        final List<byte[]> columnFamilyNames = CabinDB.listColumnFamilies(
  ...
  @Test
  public void openWithColumnFamilies() throws CabinDBException {
  ...
  @Test
  public void getWithOutValueAndCf() throws CabinDBException {
  ...
  @Test
  public void createWriteDropColumnFamily() throws CabinDBException {
    final List<ColumnFamilyDescriptor> cfDescriptors = Arrays.asList(
        new ColumnFamilyDescriptor(CabinDB.DEFAULT_COLUMN_FAMILY),
        new ColumnFamilyDescriptor("new_cf".getBytes()));
    final List<ColumnFamilyHandle> columnFamilyHandleList = new ArrayList<>();
  ...
  @Test
  public void createWriteDropColumnFamilies() throws CabinDBException {
    final List<ColumnFamilyDescriptor> cfDescriptors = Arrays.asList(
        new ColumnFamilyDescriptor(CabinDB.DEFAULT_COLUMN_FAMILY),
        new ColumnFamilyDescriptor("new_cf".getBytes()));
    final List<ColumnFamilyHandle> columnFamilyHandleList = new ArrayList<>();
  ...
  @Test
  public void writeBatch() throws CabinDBException {
  ...
  @Test
  public void iteratorOnColumnFamily() throws CabinDBException {
    final List<ColumnFamilyDescriptor> cfDescriptors = Arrays.asList(
        new ColumnFamilyDescriptor(CabinDB.DEFAULT_COLUMN_FAMILY),
        new ColumnFamilyDescriptor("new_cf".getBytes()));
    final List<ColumnFamilyHandle> columnFamilyHandleList = new ArrayList<>();
    try (final DBOptions options = new DBOptions()
      ...
      try (final CabinIterator cabinIterator = db.newIterator(columnFamilyHandleList.get(1))) {
        cabinIterator.seekToFirst();
        Map<String, String> refMap = new HashMap<>();
        refMap.put("newcfkey", "value");
        refMap.put("newcfkey2", "value2");
        int i = 0;
        while (cabinIterator.isValid()) {
          i++;
          assertThat(refMap.get(new String(cabinIterator.key())))
              .isEqualTo(new String(cabinIterator.value()));
          cabinIterator.next();
        }
  ...
  @Test
  public void properties() throws CabinDBException {
    final List<ColumnFamilyDescriptor> cfDescriptors = Arrays.asList(
        new ColumnFamilyDescriptor(CabinDB.DEFAULT_COLUMN_FAMILY),
        new ColumnFamilyDescriptor("new_cf".getBytes()));
    final List<ColumnFamilyHandle> columnFamilyHandleList = new ArrayList<>();
    try (final DBOptions options = new DBOptions()
        ...
        .setCreateMissingColumnFamilies(true);
         final CabinDB db = CabinDB.open(options,
             dbFolder.getRoot().getAbsolutePath(),
             cfDescriptors, columnFamilyHandleList)) {
      assertThat(db.getProperty("cabindb.estimate-num-keys")).isNotNull();
      assertThat(db.getLongProperty(columnFamilyHandleList.get(0), "cabindb.estimate-num-keys"))
          .isGreaterThanOrEqualTo(0);
      assertThat(db.getProperty("cabindb.stats")).isNotNull();
      assertThat(db.getProperty(columnFamilyHandleList.get(0), "cabindb.sstables")).isNotNull();
      assertThat(db.getProperty(columnFamilyHandleList.get(1), "cabindb.estimate-num-keys"))
          .isNotNull();
      assertThat(db.getProperty(columnFamilyHandleList.get(1), "cabindb.stats")).isNotNull();
      assertThat(db.getProperty(columnFamilyHandleList.get(1), "cabindb.sstables")).isNotNull();
      assertThat(db.getAggregatedLongProperty("cabindb.estimate-num-keys")).isNotNull();
      assertThat(db.getAggregatedLongProperty("cabindb.estimate-num-keys"))
          .isGreaterThanOrEqualTo(0);
    }
  }
  ...
  @Test
  public void iterators() throws CabinDBException {
    final List<ColumnFamilyDescriptor> cfDescriptors = Arrays.asList(
        new ColumnFamilyDescriptor(CabinDB.DEFAULT_COLUMN_FAMILY),
        new ColumnFamilyDescriptor("new_cf".getBytes()));
    final List<ColumnFamilyHandle> columnFamilyHandleList = new ArrayList<>();
    try (final DBOptions options = new DBOptions()
      ...
      try {
        ...
        if (iterators != null) {
          for (final CabinIterator cabinIterator : iterators) {
            cabinIterator.close();
          }
        }
      }
  ...
  public void failPutDisposedCF() throws CabinDBException {
    final List<ColumnFamilyDescriptor> cfDescriptors = Arrays.asList(
        new ColumnFamilyDescriptor(CabinDB.DEFAULT_COLUMN_FAMILY),
        new ColumnFamilyDescriptor("new_cf".getBytes()));
    final List<ColumnFamilyHandle> columnFamilyHandleList = new ArrayList<>();
  ...
  @Test(expected = CabinDBException.class)
  public void failRemoveDisposedCF() throws CabinDBException {
    final List<ColumnFamilyDescriptor> cfDescriptors = Arrays.asList(
        new ColumnFamilyDescriptor(CabinDB.DEFAULT_COLUMN_FAMILY),
        new ColumnFamilyDescriptor("new_cf".getBytes()));
    final List<ColumnFamilyHandle> columnFamilyHandleList = new ArrayList<>();
  ...
  @Test(expected = CabinDBException.class)
  public void failGetDisposedCF() throws CabinDBException {
    final List<ColumnFamilyDescriptor> cfDescriptors = Arrays.asList(
        new ColumnFamilyDescriptor(CabinDB.DEFAULT_COLUMN_FAMILY),
        new ColumnFamilyDescriptor("new_cf".getBytes()));
    final List<ColumnFamilyHandle> columnFamilyHandleList = new ArrayList<>();
  ...
  @Test(expected = CabinDBException.class)
  public void failMultiGetWithoutCorrectNumberOfCF() throws CabinDBException {
    final List<ColumnFamilyDescriptor> cfDescriptors = Arrays.asList(
        new ColumnFamilyDescriptor(CabinDB.DEFAULT_COLUMN_FAMILY),
        new ColumnFamilyDescriptor("new_cf".getBytes()));
    final List<ColumnFamilyHandle> columnFamilyHandleList = new ArrayList<>();
  ...
  @Test
  public void testByteCreateFolumnFamily() throws CabinDBException {
    ...
    try (final Options options = new Options().setCreateIfMissing(true);
      ...
      final List<byte[]> families =
          CabinDB.listColumnFamilies(options, dbFolder.getRoot().getAbsolutePath());
  ...
  @Test
  public void testCFNamesWithZeroBytes() throws CabinDBException {
  ...
  @Test
  public void testCFNameSimplifiedChinese() throws CabinDBException {
  ...
  @Test
  public void testDestroyColumnFamilyHandle() throws CabinDBException {
    try (final Options options = new Options().setCreateIfMissing(true);
   ...
   *     CabinDB instance will take care of closing its associated ColumnFamilyHandle objects.
   */
  public void testColumnFamilyCloseBeforeDb() throws CabinDBException {
    final List<ColumnFamilyDescriptor> cfNames =
        Arrays.asList(new ColumnFamilyDescriptor(CabinDB.DEFAULT_COLUMN_FAMILY),
            new ColumnFamilyDescriptor("new_cf".getBytes()));
    final List<ColumnFamilyHandle> columnFamilyHandleList = new ArrayList<>();

    try (final DBOptions options =
             new DBOptions().setCreateIfMissing(true).setCreateMissingColumnFamilies(true);
         final CabinDB db = CabinDB.open(
