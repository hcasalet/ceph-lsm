...
import static org.cabindb.util.CapturingWriteBatchHandler.Action.DELETE;
import static org.cabindb.util.CapturingWriteBatchHandler.Action.DELETE_RANGE;
import static org.cabindb.util.CapturingWriteBatchHandler.Action.LOG;
import static org.cabindb.util.CapturingWriteBatchHandler.Action.MERGE;
import static org.cabindb.util.CapturingWriteBatchHandler.Action.PUT;
import static org.cabindb.util.CapturingWriteBatchHandler.Action.SINGLE_DELETE;
...
import org.cabindb.util.CapturingWriteBatchHandler;
import org.cabindb.util.CapturingWriteBatchHandler.Event;
import org.cabindb.util.WriteBatchGetter;

/**
 * This class mimics the db/write_batch_test.cc
 * in the c++ cabindb library.
 */
public class WriteBatchTest {
  ...
  public void multipleBatchOperationsDirect()
      throws UnsupportedEncodingException, CabinDBException {
  ...
  @Test
  public void data() throws CabinDBException {
  ...
  @Test
  public void dataSize() throws CabinDBException {
    try (final WriteBatch batch = new WriteBatch()) {
      batch.put("k1".getBytes(), "v1".getBytes());
  ...
  @Test
  public void hasPut() throws CabinDBException {
    try (final WriteBatch batch = new WriteBatch()) {
  ...
  @Test
  public void hasDelete() throws CabinDBException {
    try (final WriteBatch batch = new WriteBatch()) {
  ...
  @Test
  public void hasSingleDelete() throws CabinDBException {
    try (final WriteBatch batch = new WriteBatch()) {
  ...
  @Test
  public void hasDeleteRange() throws CabinDBException {
    try (final WriteBatch batch = new WriteBatch()) {
  ...
  @Test
  public void hasBeginPrepareRange() throws CabinDBException {
    try (final WriteBatch batch = new WriteBatch()) {
  ...
  @Test
  public void hasEndPrepareRange() throws CabinDBException {
    try (final WriteBatch batch = new WriteBatch()) {
  ...
  @Test
  public void hasCommit() throws CabinDBException {
    try (final WriteBatch batch = new WriteBatch()) {
  ...
  @Test
  public void hasRollback() throws CabinDBException {
    try (final WriteBatch batch = new WriteBatch()) {
  ...
  @Test
  public void walTerminationPoint() throws CabinDBException {
    try (final WriteBatch batch = new WriteBatch()) {
