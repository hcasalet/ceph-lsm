...
public class OptionsUtilTest {
  @ClassRule
  public static final CabinNativeLibraryResource CABIN_NATIVE_LIBRARY_RESOURCE = new CabinNativeLibraryResource();
  ...
  @Test
  public void loadLatestOptions() throws CabinDBException {
    verifyOptions(TestAPI.LOAD_LATEST_OPTIONS);
  }

  @Test
  public void loadOptionsFromFile() throws CabinDBException {
    verifyOptions(TestAPI.LOAD_OPTIONS_FROM_FILE);
  }

  @Test
  public void getLatestOptionsFileName() throws CabinDBException {
    final String dbPath = dbFolder.getRoot().getAbsolutePath();
    try (final Options options = new Options().setCreateIfMissing(true);
         final CabinDB db = CabinDB.open(options, dbPath)) {
  ...
  private void verifyOptions(TestAPI apiType) throws CabinDBException {
    final String dbPath = dbFolder.getRoot().getAbsolutePath();
    ...
    assertThat(cfDescs.get(0).getName()).isEqualTo(CabinDB.DEFAULT_COLUMN_FAMILY);
