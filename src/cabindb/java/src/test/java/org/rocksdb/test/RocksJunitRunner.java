...
public class CabinJunitRunner {
  ...
  static class CabinJunitListener extends TextListener {
    ...
    /**
     * CabinJunitListener constructor
     *
     * @param system JUnitSystem
     */
    public CabinJunitListener(final JUnitSystem system) {
      this(system.out());
    }

    public CabinJunitListener(final PrintStream writer) {
      super(writer);
      this.writer = writer;
    }
    ...
    public void testRunStarted(final Description description) {
      writer.format("Starting CabinJava Tests...%n");
  ...
  public static void main(final String[] args){
    ...
    runner.addListener(new CabinJunitListener(system));
    try {
