...
public class MemTableTest {
  ...
  @Test
  public void hashSkipListMemTable() throws CabinDBException {
  ...
  @Test
  public void skipListMemTable() throws CabinDBException {
    try(final Options options = new Options()) {
  ...
  @Test
  public void hashLinkedListMemTable() throws CabinDBException {
    try(final Options options = new Options()) {
  ...
  @Test
  public void vectorMemTable() throws CabinDBException {
    try(final Options options = new Options()) {
