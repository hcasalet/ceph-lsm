...
public class SstFileManagerTest {
  ...
  @Test
  public void maxAllowedSpaceUsage() throws CabinDBException {
  ...
  @Test
  public void compactionBufferSize() throws CabinDBException {
    try (final SstFileManager sstFileManager = new SstFileManager(Env.getDefault())) {
  ...
  @Test
  public void totalSize() throws CabinDBException {
    try (final SstFileManager sstFileManager = new SstFileManager(Env.getDefault())) {
  ...
  @Test
  public void trackedFiles() throws CabinDBException {
    try (final SstFileManager sstFileManager = new SstFileManager(Env.getDefault())) {
  ...
  @Test
  public void deleteRateBytesPerSecond() throws CabinDBException {
    try (final SstFileManager sstFileManager = new SstFileManager(Env.getDefault())) {
  ...
  @Test
  public void maxTrashDBRatio() throws CabinDBException {
    try (final SstFileManager sstFileManager = new SstFileManager(Env.getDefault())) {
