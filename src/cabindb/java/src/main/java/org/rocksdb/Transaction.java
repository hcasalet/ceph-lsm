 ...
 * {@link OptimisticTransactionDB#beginTransaction(org.cabindb.WriteOptions)} or
 * {@link TransactionDB#beginTransaction(org.cabindb.WriteOptions)}
 *
 ...
 * examples.
 */
public class Transaction extends CabinObject {

  private final CabinDB parent;

  /**
   * Intentionally package private
   * as this is called from
   * {@link OptimisticTransactionDB#beginTransaction(org.cabindb.WriteOptions)}
   * or {@link TransactionDB#beginTransaction(org.cabindb.WriteOptions)}
   *
   ...
   *     transaction object
   */
  Transaction(final CabinDB parent, final long transactionHandle) {
  ...
  */
   ...
   */
  void prepare() throws CabinDBException {
   ...
   *
   * @throws CabinDBException if an error occurs when committing the transaction
   */
  public void commit() throws CabinDBException {
    assert(isOwningHandle());
   ...
   *
   * @throws CabinDBException if an error occurs when rolling back the transaction
   */
  public void rollback() throws CabinDBException {
    assert(isOwningHandle());
   ...
   *
   * @throws CabinDBException if an error occurs whilst setting a save point
   */
  public void setSavePoint() throws CabinDBException {
    assert(isOwningHandle());
   ...
   *
   * @throws CabinDBException if an error occurs when rolling back to a save point
   */
   ...
   * {@link CabinDB#get(ColumnFamilyHandle, ReadOptions, byte[])} except it will
  ...
  public byte[] get(final ColumnFamilyHandle columnFamilyHandle,
      final ReadOptions readOptions, final byte[] key) throws CabinDBException {
    assert(isOwningHandle());
  ...
  /**
   * This function is similar to
   * {@link CabinDB#get(ReadOptions, byte[])} except it will
   * also read pending changes in this transaction.
   * Currently, this function will return Status::MergeInProgress if the most
   * recent write to the queried key in this batch is a Merge.
   *
  ...
  /**
   * This function is similar to
   * {@link CabinDB#multiGet(ReadOptions, List, List)} except it will
   * also read pending changes in this transaction.
   * Currently, this function will return Status::MergeInProgress if the most
   * recent write to the queried key in this batch is a Merge.
   *
  ...
  public byte[][] multiGet(final ReadOptions readOptions,
      ...
      final byte[][] keys) throws CabinDBException {
    assert(isOwningHandle());
  ...
  /**
   * This function is similar to
   * {@link CabinDB#multiGet(ReadOptions, List)} except it will
   * also read pending changes in this transaction.
   * Currently, this function will return Status::MergeInProgress if the most
   * recent write to the queried key in this batch is a Merge.
   *
   ...
   * {@link CabinDB#get(ColumnFamilyHandle, ReadOptions, byte[])}.
   ...
   * {@link CabinDBException} may be thrown with an accompanying {@link Status}
   * when:
  ...
  public byte[] getForUpdate(final ReadOptions readOptions,
      ...
      final boolean doValidate) throws CabinDBException {
    assert (isOwningHandle());
  ...
  public byte[] getForUpdate(final ReadOptions readOptions,
      ...
      final boolean exclusive) throws CabinDBException {
    assert(isOwningHandle());
    return getForUpdate(nativeHandle_, readOptions.nativeHandle_, key, key.length,
   ...
   *
   * The values returned by this function are similar to
   * {@link CabinDB#get(ReadOptions, byte[])}.
   * If value==nullptr, then this function will not read any data, but will
   * still ensure that this key cannot be written to by outside of this
   * transaction.
   *
   ...
   *
   * @param readOptions Read options.
   * @param columnFamilyHandles {@link org.cabindb.ColumnFamilyHandle}
   *     instances
   ...
   */
  public CabinIterator getIterator(final ReadOptions readOptions) {
    assert(isOwningHandle());
    return new CabinIterator(parent, getIterator(nativeHandle_,
   ...
   * fetched regardless).
   *
   * Caller is responsible for calling {@link CabinIterator#close()} on
  ...
  /**
   * Similar to {@link CabinDB#put(ColumnFamilyHandle, byte[], byte[])}, but
   ...
   *
   * @throws CabinDBException when one of the TransactionalDB conditions
  ...
  public void put(final ColumnFamilyHandle columnFamilyHandle, final byte[] key,
      final byte[] value, final boolean assumeTracked) throws CabinDBException {
    assert (isOwningHandle());
  ...
  /**
   * Similar to {@link CabinDB#put(byte[], byte[])}, but
   * will also perform conflict checking on the keys be written.
   *
   * If this Transaction was created on an {@link OptimisticTransactionDB},
   * these functions should always succeed.
  ...
  //TODO(AR) refactor if we implement org.cabindb.SliceParts in future
  /**
  ...
  public void put(final ColumnFamilyHandle columnFamilyHandle,
      ...
      final boolean assumeTracked) throws CabinDBException {
    assert (isOwningHandle());
  ...
  /**
   * Similar to {@link CabinDB#merge(ColumnFamilyHandle, byte[], byte[])}, but
   * will also perform conflict checking on the keys be written.
   *
   * If this Transaction was created on an {@link OptimisticTransactionDB},
   * these functions should always succeed.
  ...
  /**
   * Similar to {@link CabinDB#merge(byte[], byte[])}, but
   * will also perform conflict checking on the keys be written.
   *
   * If this Transaction was created on an {@link OptimisticTransactionDB},
   * these functions should always succeed.
  ...
  /**
   * Similar to {@link CabinDB#delete(ColumnFamilyHandle, byte[])}, but
   * will also perform conflict checking on the keys be written.
   *
   * If this Transaction was created on an {@link OptimisticTransactionDB},
   * these functions should always succeed.
  ...
  public void delete(final ColumnFamilyHandle columnFamilyHandle,
      final byte[] key, final boolean assumeTracked) throws CabinDBException {
    assert (isOwningHandle());
  ...
  /**
   * Similar to {@link CabinDB#delete(byte[])}, but
   * will also perform conflict checking on the keys be written.
   *
   * If this Transaction was created on an {@link OptimisticTransactionDB},
   * these functions should always succeed.
   ...
   */
  public void delete(final ColumnFamilyHandle columnFamilyHandle,
      final byte[][] keyParts) throws CabinDBException {
    assert(isOwningHandle());
    delete(nativeHandle_, keyParts, keyParts.length,
        columnFamilyHandle.nativeHandle_, false);
  }
   ...
   *     described above occurs, or in the case of an unexpected error
   */
  public void delete(final byte[][] keyParts) throws CabinDBException {
    assert(isOwningHandle());
    delete(nativeHandle_, keyParts, keyParts.length);
  }

  /**
   * Similar to {@link CabinDB#singleDelete(ColumnFamilyHandle, byte[])}, but
   * will also perform conflict checking on the keys be written.
   *
   * If this Transaction was created on an {@link OptimisticTransactionDB},
   * these functions should always succeed.
  ...
  /**
   * Similar to {@link CabinDB#singleDelete(byte[])}, but
   * will also perform conflict checking on the keys be written.
   *
   * If this Transaction was created on an {@link OptimisticTransactionDB},
   * these functions should always succeed.
   ...
   */
  @Experimental("Performance optimization for a very specific workload")
  public void singleDelete(final byte[][] keyParts) throws CabinDBException {
    assert(isOwningHandle());
    singleDelete(nativeHandle_, keyParts, keyParts.length);
  }

  /**
   * Similar to {@link CabinDB#put(ColumnFamilyHandle, byte[], byte[])},
   ...
   * conflicts in other transactions; This may cause a {@link CabinDBException}
  ...
  /**
   * Similar to {@link CabinDB#put(byte[], byte[])},
   * but operates on the transactions write batch. This write will only happen
   * if this transaction gets committed successfully.
   *
  ...
  /**
   * Similar to {@link CabinDB#merge(ColumnFamilyHandle, byte[], byte[])},
   * but operates on the transactions write batch. This write will only happen
   * if this transaction gets committed successfully.
   *
  ...
  /**
   * Similar to {@link CabinDB#merge(byte[], byte[])},
   * but operates on the transactions write batch. This write will only happen
   * if this transaction gets committed successfully.
   *
  ...
  /**
   * Similar to {@link CabinDB#delete(ColumnFamilyHandle, byte[])},
   * but operates on the transactions write batch. This write will only happen
   * if this transaction gets committed successfully.
   *
  ...
  /**
   * Similar to {@link CabinDB#delete(byte[])},
   * but operates on the transactions write batch. This write will only happen
   * if this transaction gets committed successfully.
   *
   ...
   *     described above occurs, or in the case of an unexpected error
   */
  public void deleteUntracked(final byte[] key) throws CabinDBException {
    assert(isOwningHandle());
    deleteUntracked(nativeHandle_, key, key.length);
  }
   ...
   *     described above occurs, or in the case of an unexpected error
   */
  public void deleteUntracked(final byte[][] keyParts) throws CabinDBException {
    assert(isOwningHandle());
    deleteUntracked(nativeHandle_, keyParts, keyParts.length);
  }
   ...
   *
   * @throws CabinDBException if an error occurs whilst rebuilding from the
   *     write batch.
   */
   ...
   *
   * @throws CabinDBException if an error occurs when setting the transaction
   *     name.
   */
  public void setName(final String transactionName) throws CabinDBException {
    assert(isOwningHandle());
  ...
  public enum TransactionState {
     ...
     *
     * @return {@link org.cabindb.Transaction.TransactionState} instance or null.
  ...
  private native void prepare(final long handle) throws CabinDBException;
  private native void commit(final long handle) throws CabinDBException;
  private native void rollback(final long handle) throws CabinDBException;
  private native void setSavePoint(final long handle) throws CabinDBException;
  ...
  private native byte[] get(final long handle, final long readOptionsHandle,
      ...
      throws CabinDBException;
  private native byte[] get(final long handle, final long readOptionsHandle,
      final byte key[], final int keyLen) throws CabinDBException;
  ...
  private native void delete(final long handle, final byte[] key, final int keyLength,
      final long columnFamilyHandle, final boolean assumeTracked) throws CabinDBException;
  ...
  private native void delete(final long handle, final byte[][] keys,
      final int keysLength) throws CabinDBException;
  ...
  private native void rebuildFromWriteBatch(final long handle,
      final long writeBatchHandle) throws CabinDBException;
