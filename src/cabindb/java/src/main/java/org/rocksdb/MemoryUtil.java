...
public class MemoryUtil {
   ...
   * usage of all the mem-tables from all the input cabindb instances.</p>
   *
   ...
   */
  public static Map<MemoryUsageType, Long> getApproximateMemoryUsageByType(final List<CabinDB> dbs, final Set<Cache> caches) {
    ...
    if (dbCount > 0) {
      ListIterator<CabinDB> dbIter = dbs.listIterator();
