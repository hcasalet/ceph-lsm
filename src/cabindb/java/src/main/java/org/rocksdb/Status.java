...
/**
 * Represents the status returned by a function call in CabinDB.
 *
 * Currently only used with {@link CabinDBException} when the
...
public class Status {
  ...
  // should stay in sync with /include/cabindb/status.h:Code and /java/cabinjni/portal.h:toJavaStatusCode
  public enum Code {
    Ok(                 (byte)0x0),
    NotFound(           (byte)0x1),
    Corruption(         (byte)0x2),
  ...
  // should stay in sync with /include/cabindb/status.h:SubCode and /java/cabinjni/portal.h:toJavaStatusSubCode
  public enum SubCode {
    None(         (byte)0x0),
