 ...
 */
public class CompactRangeOptions extends CabinObject {
  ...
  public enum BottommostLevelCompaction {
    ...
    /**
     * Returns the BottommostLevelCompaction for the given C++ cabin enum value.
     ...
     */
    public static BottommostLevelCompaction fromCabinId(final int bottommostLevelCompaction) {
  ...
  public BottommostLevelCompaction bottommostLevelCompaction() {
    return BottommostLevelCompaction.fromCabinId(bottommostLevelCompaction(nativeHandle_));
  }
