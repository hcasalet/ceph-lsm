...
/**
 * Comparators are used by CabinDB to determine
...
public abstract class AbstractComparator
   ...
   *
   * Names starting with "cabindb." are reserved and should not be used.
   *
   ...
   * underlying bytes. As a callback, CabinJava will ensure that {@code a}
