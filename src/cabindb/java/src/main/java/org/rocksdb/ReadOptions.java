 ...
 */
public class ReadOptions extends CabinObject {
  public ReadOptions() {
   ...
   * found at the specified cache, then {@link CabinDBException} is thrown.
   *
   ...
   * Default: false
   *
   * Not supported in {@code CABINDB_LITE} mode!
   *
   ...
   * {@link CabinIterator#isValid()} will be false.
   *
  ...
  // close() would also reap its associated cabindb::Slice native object since
