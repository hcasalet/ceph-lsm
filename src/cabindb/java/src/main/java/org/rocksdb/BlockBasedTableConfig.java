 ...
 *
 * BlockBasedTable is a CabinDB's default SST file format.
 */
...
public class BlockBasedTableConfig extends TableFormatConfig {
   ...
   *
   * @param indexType {@link org.cabindb.IndexType} value
   ...
   *
   * @param dataBlockIndexType {@link org.cabindb.DataBlockIndexType} value
   * @return the reference to the current option.
   */
   ...
   * Sets
   *
   * @param checksumType {@link org.cabindb.ChecksumType} value.
   * @return the reference to the current option.
   */
   ...
   *
   * {@link org.cabindb.Cache} should not be disposed before options instances
   * using this cache is disposed.
   *
   * {@link org.cabindb.Cache} instance can be re-used in multiple options
   * instances.
   *
   * @param blockCache {@link org.cabindb.Cache} Cache java instance
   *     (e.g. LRUCache).
   *
   * @return the reference to the current config.
   */
   ...
   *
   * If {@code null}, CabinDB will not use a compressed block cache.
   *
   * Note: though it looks similar to {@link #setBlockCache(Cache)}, CabinDB
   ...
   * instances.
   *
   * @param blockCacheCompressed {@link org.cabindb.Cache} Cache java instance
   *     (e.g. LRUCache).
   *
   * @return the reference to the current config.
   */
   ...
   * this option, CabinDB might access an allocated memory object beyond its
   ...
   *
   * {@link org.cabindb.Filter} should not be disposed before options instances
   * using this filter is disposed. If {@link Filter#dispose()} function is not
   * called, then filter object will be GC'd automatically.
   *
   * {@link org.cabindb.Filter} instance can be re-used in multiple options
   * instances.
   *
   * @param filterPolicy {@link org.cabindb.Filter} Filter Policy java instance.
   * @return the reference to the current config.
   */
   ...
   * out by all CabinDB's versions by default. Can be read by really old
   * CabinDB's. Doesn't support changing checksum (default is CRC32).</li>
   * <li><strong>1</strong> - Can be read by CabinDB's versions since 3.0.
   * Supports non-default checksum, like xxHash. It is written by CabinDB when
   * BlockBasedTableOptions::checksum is something other than kCRC32c. (version
   * 0 is silently upconverted)</li>
   * <li><strong>2</strong> - Can be read by CabinDB's versions since 3.10.
   * Changes the way we encode compressed blocks with LZ4, BZip2 and Zlib
   * compression. If you don't plan to run CabinDB before version 3.10,
   * you should probably use this.</li>
   * <li><strong>3</strong> - Can be read by CabinDB's versions since 5.15. Changes the way we
   * encode the keys in index blocks. If you don't plan to run CabinDB before
   * version 5.15, you should probably use this.
   * This option only affects newly written tables. When reading existing
   * tables, the information about version is read from the footer.</li>
   * <li><strong>4</strong> - Can be read by CabinDB's versions since 5.16. Changes the way we
   * encode the values in index blocks. If you don't plan to run CabinDB before
   * version 5.16 and you are using index_block_restart_interval &gt; 1, you should
   * probably use this as it would reduce the index size.
   * This option only affects newly written tables. When reading existing
   * tables, the information about version is read from the footer.</li>
   * <li><strong>5</strong> - Can be read by CabinDB's versions since 6.6.0.
  ...
  /**
   * Get the size of the cache in bytes that will be used by CabinDB.
   *
  ...
  /**
   * Set the size of the cache in bytes that will be used by CabinDB.
