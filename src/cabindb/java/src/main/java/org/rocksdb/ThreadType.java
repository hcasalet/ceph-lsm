...
public enum ThreadType {
  /**
   * CabinDB BG thread in high-pri thread pool.
   */
  HIGH_PRIORITY((byte)0x0),

  /**
   * CabinDB BG thread in low-pri thread pool.
   */
  LOW_PRIORITY((byte)0x1),

  /**
   * User thread (Non-CabinDB BG thread).
   */
  USER((byte)0x2),

  /**
   * CabinDB BG thread in bottom-pri thread pool
   */
