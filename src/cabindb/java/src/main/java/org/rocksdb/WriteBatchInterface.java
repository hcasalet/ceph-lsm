...
public interface WriteBatchInterface {
     ...
     * @throws CabinDBException thrown if error happens in underlying native library.
     */
    void put(byte[] key, byte[] value) throws CabinDBException;
    ...
    void put(ColumnFamilyHandle columnFamilyHandle,
                    byte[] key, byte[] value) throws CabinDBException;
     ...
     */
    void put(ByteBuffer key, ByteBuffer value) throws CabinDBException;
     ...
     * @throws CabinDBException thrown if error happens in underlying native library.
     */
    void merge(byte[] key, byte[] value) throws CabinDBException;
     ...
     */
    @Deprecated
    void remove(byte[] key) throws CabinDBException;
     ...
     * @throws CabinDBException thrown if error happens in underlying native library.
     */
    void delete(byte[] key) throws CabinDBException;
    ...
    void singleDelete(final byte[] key) throws CabinDBException;
     ...
     * @throws CabinDBException
     */
    void remove(ByteBuffer key) throws CabinDBException;
     ...
     * @throws CabinDBException
     */
    void remove(ColumnFamilyHandle columnFamilyHandle, ByteBuffer key) throws CabinDBException;
     ...
     * @throws CabinDBException thrown if error happens in underlying native library.
     */
    void deleteRange(byte[] beginKey, byte[] endKey) throws CabinDBException;
    ...
    void deleteRange(ColumnFamilyHandle columnFamilyHandle, byte[] beginKey,
            byte[] endKey) throws CabinDBException;
     ...
     * @throws CabinDBException thrown if error happens in underlying native library.
     */
    void putLogData(byte[] blob) throws CabinDBException;
     ...
     * point.
     *
     * @throws CabinDBException if there is no previous call to SetSavePoint()
     */
    void rollbackToSavePoint() throws CabinDBException;
     ...
     *
     * @throws CabinDBException If there is no previous call to
     *     {@link #setSavePoint()}, an exception with
     *     {@link Status.Code#NotFound} will be thrown.
     */
    void popSavePoint() throws CabinDBException;
