 ...
 */
//@ThreadSafe
public final class SstFileManager extends CabinObject {
  ...
  /**
   * Create a new SstFileManager that can be shared among multiple CabinDB
   ...
   */
  public SstFileManager(final Env env) throws CabinDBException {
    this(env, null);
  }
   ...
   */
  public SstFileManager(final Env env, /*@Nullable*/  final Logger logger,
      final long rateBytesPerSec) throws CabinDBException {
  ...
  public SstFileManager(final Env env, /*@Nullable*/final Logger logger,
      final long rateBytesPerSec, final double maxTrashDbRatio,
      final long bytesMaxDeleteChunk) throws CabinDBException {
  ...
  /**
   * Update the maximum allowed space that should be used by CabinDB, if
