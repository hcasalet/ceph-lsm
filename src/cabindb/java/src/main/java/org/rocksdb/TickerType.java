...
/**
 * The logical mapping of tickers defined in cabindb::Tickers.
 *
 * Java byte value mappings don't align 1:1 to the c++ values. c++ cabindb::Tickers enumeration type
 * is uint32_t and java org.cabindb.TickerType is byte, this causes mapping issues when
 * cabindb::Tickers value is greater then 127 (0x7F) for jbyte jni interface as range greater is not
 * available. Without breaking interface in minor versions, value mappings for
 * org.cabindb.TickerType leverage full byte range [-128 (-0x80), (0x7F)]. Newer tickers added
...
public enum TickerType {
    ...
    /**
     * Record the number of calls to {@link CabinDB#getUpdatesSince(long)}. Useful to keep track of
     ...
     *
     * @return {@link org.cabindb.TickerType} instance.
