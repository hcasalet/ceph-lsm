 ...
 * implemented in C++.
 *
 * The native comparator must directly extend cabindb::Comparator.
 */
public abstract class NativeComparatorWrapper
   ...
   * as disposing of a native cabindb::Comparator extension requires
   * a slightly different approach as it is not really a CabinCallbackObject
   */
  @Override
