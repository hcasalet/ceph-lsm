 ...
 */
public class BackupEngine extends CabinObject implements AutoCloseable {
   ...
   * @throws CabinDBException thrown if the backup engine could not be opened
   */
  public static BackupEngine open(final Env env,
      final BackupableDBOptions options) throws CabinDBException {
   ...
   *
   * Just a convenience for {@link #createNewBackup(CabinDB, boolean)} with
   ...
   *
   * @throws CabinDBException thrown if a new backup could not be created
   */
  public void createNewBackup(final CabinDB db) throws CabinDBException {
  ...
  public void createNewBackup(
      final CabinDB db, final boolean flushBeforeBackup)
   ...
   * @throws CabinDBException thrown if a new backup could not be created
   */
  public void createNewBackupWithMetadata(final CabinDB db, final String metadata,
      final boolean flushBeforeBackup) throws CabinDBException {
    assert (isOwningHandle());
   ...
   *    native library.
   */
  public void garbageCollect() throws CabinDBException {
    assert(isOwningHandle());
   ...
   *
   * @throws CabinDBException thrown if the old backups could not be deleted
   */
  public void purgeOldBackups(
      final int numBackupsToKeep) throws CabinDBException {
    assert (isOwningHandle());
   ...
   *
   * @throws CabinDBException thrown if the backup could not be deleted
   */
  public void deleteBackup(final int backupId) throws CabinDBException {
    assert (isOwningHandle());
   ...
   *
   * @throws CabinDBException thrown if the database could not be restored
   */
  public void restoreDbFromBackup(
      final int backupId, final String dbDir, final String walDir,
      final RestoreOptions restoreOptions) throws CabinDBException {
    assert (isOwningHandle());
  ...
  private native static long open(final long env,
      final long backupableDbOptions) throws CabinDBException;
  ...
  private native void createNewBackupWithMetadata(final long handle, final long dbHandle,
      final String metadata, final boolean flushBeforeBackup) throws CabinDBException;

  private native List<BackupInfo> getBackupInfo(final long handle);

  private native int[] getCorruptedBackups(final long handle);

  private native void garbageCollect(final long handle) throws CabinDBException;
