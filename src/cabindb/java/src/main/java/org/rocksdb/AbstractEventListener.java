...
import static org.cabindb.AbstractEventListener.EnabledEventCallback.*;

/**
 * Base class for Event Listeners.
 */
public abstract class AbstractEventListener extends CabinCallbackObject implements EventListener {
  ...
  private void onFlushCompletedProxy(final long dbHandle, final FlushJobInfo flushJobInfo) {
    final CabinDB db = new CabinDB(dbHandle);
  ...
  /**
   * Called from JNI, proxy for
   *     {@link #onFlushBegin(CabinDB, FlushJobInfo)}.
   *
   * @param dbHandle native handle of the database
   * @param flushJobInfo the flush job info
   */
  ...
  /**
   * Called from JNI, proxy for
   *     {@link #onCompactionBegin(CabinDB, CompactionJobInfo)}.
   *
   * @param dbHandle native handle of the database
  ...
  /**
   * Called from JNI, proxy for
   *     {@link #onExternalFileIngested(CabinDB, ExternalFileIngestionInfo)}.
   *
   * @param dbHandle native handle of the database
