...
/**
 * Slices are used by CabinDB to provide
 ...
 *   @see org.cabindb.Slice
 *   @see org.cabindb.DirectSlice
 *
 * Regards the lifecycle of Java Slices in CabinDB:
 *   At present when you configure a Comparator from Java, it creates an
 *   instance of a C++ BaseComparatorJniCallback subclass and
 *   passes that to CabinDB as the comparator. That subclass of
 *   BaseComparatorJniCallback creates the Java
 *   @see org.cabindb.AbstractSlice subclass Objects. When you dispose
 *   the Java @see org.cabindb.AbstractComparator subclass, it disposes the
 *   C++ BaseComparatorJniCallback subclass, which in turn destroys the
 *   Java @see org.cabindb.AbstractSlice subclass Objects.
 */
public abstract class AbstractSlice<T> extends CabinMutableObject {
   ...
   *   @see org.cabindb.AbstractSlice#data0(long)
   */
  public T data() {
   ...
   * CabinDB instances referencing the slice are closed.
