...
public interface ColumnFamilyOptionsInterface<T extends ColumnFamilyOptionsInterface<T>>
   ...
   * CabinDB options, use the following for level style compaction.</p>
   *
   ...
   * optimized for heavy workloads and big datasets, which means you might
   * observe write stalls under some conditions. As a starting point for tuning
   * CabinDB options, use the following for universal style compaction.</p>
   *
  ...
  /**
   * Set {@link BuiltinComparator} to be used with CabinDB.
   *
   ...
   * standard merge operators provided by CabinDB. The available
   ...
   * @see #setTableFormatConfig(org.cabindb.TableFormatConfig)
   */
