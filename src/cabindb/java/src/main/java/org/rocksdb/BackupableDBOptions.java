 ...
 * It will be used during the creation of a {@link org.cabindb.BackupEngine}.
 * </p>
 * <p>Note that dispose() must be called before an Options instance
 * become out-of-scope to release the allocated memory in c++.</p>
 *
 * @see org.cabindb.BackupEngine
 */
public class BackupableDBOptions extends CabinObject {
   ...
   * {@link BackupEngine#createNewBackup(CabinDB, boolean)} and
