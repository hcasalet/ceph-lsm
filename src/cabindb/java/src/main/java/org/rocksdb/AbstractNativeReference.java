...
/**
 * AbstractNativeReference is the base-class of all CabinDB classes that have
 * a pointer to a native C++ {@code cabindb} object.
 * <p>
...
public abstract class AbstractNativeReference implements AutoCloseable {
   ...
   * released.
   *
   * @deprecated You should not rely on GC of Cabin objects, and instead should
