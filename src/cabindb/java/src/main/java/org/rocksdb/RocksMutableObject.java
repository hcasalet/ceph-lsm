...
/**
 * CabinMutableObject is an implementation of {@link AbstractNativeReference}
 * whose reference to the underlying native C++ object can change.
 *
 * <p>The use of {@code CabinMutableObject} should be kept to a minimum, as it
 * has synchronization overheads and introduces complexity. Instead it is
 * recommended to use {@link CabinObject} where possible.</p>
 */
public abstract class CabinMutableObject extends AbstractNativeReference {
  ...
  protected CabinMutableObject() {
  }

  protected CabinMutableObject(final long nativeHandle) {
