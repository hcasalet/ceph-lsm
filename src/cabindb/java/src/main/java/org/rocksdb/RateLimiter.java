 ...
 * @since 3.10.0
 */
public class RateLimiter extends CabinObject {
   ...
   *     and flush in bytes per second. Currently, CabinDB does not enforce
   ...
   *     Currently, CabinDB assigns low-pri to request from compaction and
