 ...
 */
public class DBOptions extends CabinObject
   ...
   * an {@code cabindb::DBOptions} in the c++ side.
   */
  public DBOptions() {
    super(newDBOptions());
   ...
   * the context of CabinDB the method will return a null
   * value.</p>
   *
   ...
   *
   * @return {@link org.cabindb.DBOptions instance}
   *     or null.
   *
