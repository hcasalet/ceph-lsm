 ...
 */
public class Statistics extends CabinObject {
   ...
   *
   * @throws CabinDBException if an error occurs when resetting the statistics.
   */
  ...
  private native void reset(final long nativeHandle) throws CabinDBException;
