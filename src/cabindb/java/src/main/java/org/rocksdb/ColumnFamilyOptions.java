 ...
 */
public class ColumnFamilyOptions extends CabinObject
   ...
   * an {@code cabindb::ColumnFamilyOptions} in the c++ side.
   */
   ...
   *
   * @return {@link org.cabindb.ColumnFamilyOptions instance}
   *     or null.
   *
