 ...
 */
public class TransactionDB extends CabinDB
  ...
  /**
   * Open a TransactionDB, similar to {@link CabinDB#open(Options, String)}.
   *
   * @param options {@link org.cabindb.Options} instance.
   * @param transactionDbOptions {@link org.cabindb.TransactionDBOptions}
   *     instance.
   ...
   *
   * @throws CabinDBException if an error occurs whilst opening the database.
   */
   ...
   * {@link CabinDB#open(DBOptions, String, List, List)}.
   *
