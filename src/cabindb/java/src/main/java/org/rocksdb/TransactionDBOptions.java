...
public class TransactionDBOptions extends CabinObject {
   ...
   * OUTSIDE of a transaction (ie by calling {@link CabinDB#put},
   * {@link CabinDB#merge}, {@link CabinDB#delete} or {@link CabinDB#write}
   * directly).
   *
   * If 0, no waiting is done if a lock cannot instantly be acquired.
