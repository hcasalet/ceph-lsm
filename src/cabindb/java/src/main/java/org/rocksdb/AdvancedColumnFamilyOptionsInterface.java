 ...
 *
 * Taken from include/cabindb/advanced_options.h
 */
public interface AdvancedColumnFamilyOptionsInterface<
   ...
   *     {@link org.cabindb.CompressionType} instances.
   *
   * @return the reference to the current options.
   */
  ...
  /**
   * <p>Return the currently set {@link org.cabindb.CompressionType}
   * per instances.</p>
   *
   * <p>See: {@link #setCompressionPerLevel(java.util.List)}</p>
   *
   * @return list of {@link org.cabindb.CompressionType}
   *     instances.
   */
  ...
  /**
   * <p>If {@code true}, CabinDB will pick target size of each level
  ...
  /**
   * In debug mode, CabinDB run consistency checks on the LSM every time the LSM
