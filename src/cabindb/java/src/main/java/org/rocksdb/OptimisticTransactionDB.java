 ...
 */
public class OptimisticTransactionDB extends CabinDB
   ...
   * {@link CabinDB#open(Options, String)}.
   *
   ...
   */
  public CabinDB getBaseDB() {
    final CabinDB db = new CabinDB(getBaseDB(nativeHandle_));
