...
public class WriteBatch extends AbstractWriteBatch {
   ...
   *
   * @throws CabinDBException If we cannot iterate over the batch
   */
  public void iterate(final Handler handler) throws CabinDBException {
   ...
   *
   * @throws CabinDBException if an error occurs whilst retrieving
   *   the serialized batch data.
   */
  public byte[] data() throws CabinDBException {
  ...
  @Override final native void putLogData(final long handle,
      final byte[] blob, final int blobLen) throws CabinDBException;
  ...
  private native byte[] data(final long nativeHandle) throws CabinDBException;
  ...
  public static abstract class Handler
    ...
    public abstract void markBeginPrepare() throws CabinDBException;
