 ...
 */
public interface CabinIteratorInterface {
   ...
   *                          native library.
   */
  void status() throws CabinDBException;
   ...
   *
   * @throws CabinDBException thrown if the operation is not supported or an error happens in the
   *     underlying native library
   */
  void refresh() throws CabinDBException;
}
