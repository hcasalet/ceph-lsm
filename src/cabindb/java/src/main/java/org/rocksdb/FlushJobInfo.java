...
public class FlushJobInfo {
  ...
  /**
   * Determine if cabindb is currently slowing-down all writes to prevent
   ...
   *
   * @return true if cabindb is currently slowing-down all writes,
   *     false otherwise
   */
  ...
  /**
   * Determine if cabindb is currently blocking any writes to prevent
   ...
   * as possible.
   *
   * @return true  if cabindb is currently blocking any writes, false otherwise
   */
