 ...
 */
public class TtlDB extends CabinDB {
   ...
   */
  public static TtlDB open(final Options options, final String db_path,
      final int ttl, final boolean readOnly) throws CabinDBException {
  ...
  public ColumnFamilyHandle createColumnFamilyWithTtl(
      ...
      final int ttl) throws CabinDBException {
  ...
  private native static long[] openCF(final long optionsHandle,
      ...
      final boolean readOnly) throws CabinDBException;
