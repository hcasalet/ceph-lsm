...
import org.cabindb.AbstractComparator;
import org.cabindb.BuiltinComparator;
import org.cabindb.ComparatorOptions;
import org.cabindb.Slice;
...
public final class ReverseBytewiseComparator extends AbstractComparator {
  ...
  @Override
  public String name() {
    return "cabindb.java.ReverseBytewiseComparator";
  }
