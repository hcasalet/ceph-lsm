 ...
 *
 * CabinDB supports different styles of compaction. Available
 ...
 *   {@link CabinDB#compactFiles(CompactionOptions, ColumnFamilyHandle, List, int, int, CompactionJobInfo)} ()}.</li>
 * </ol>
 *
 * @see <a
 * href="https://github.com/facebook/cabindb/wiki/Universal-Compaction">
 * Universal Compaction</a>
 * @see <a
 * href="https://github.com/facebook/cabindb/wiki/FIFO-compaction-style">
 * FIFO Compaction</a>
 */
