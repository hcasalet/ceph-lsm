...
DEFINE_string(
    options_file, "",
    "The path to a CabinDB options file.  If specified, then db_stress will "
...
DEFINE_int32(
    write_buffer_size,
    static_cast<int32_t>(CABINDB_NAMESPACE::Options().write_buffer_size),
...
DEFINE_double(memtable_prefix_bloom_size_ratio,
              CABINDB_NAMESPACE::Options().memtable_prefix_bloom_size_ratio,
              "creates prefix blooms for memtables, each with size "
              "`write_buffer_size * memtable_prefix_bloom_size_ratio`.");

DEFINE_bool(memtable_whole_key_filtering,
            CABINDB_NAMESPACE::Options().memtable_whole_key_filtering,
...
DEFINE_int32(compaction_style, CABINDB_NAMESPACE::Options().compaction_style,
             "");

DEFINE_int32(num_levels, CABINDB_NAMESPACE::Options().num_levels,
...
DEFINE_int32(
    ...
    static_cast<int32_t>(CABINDB_NAMESPACE::PinningTier::kFallback),
...
DEFINE_int32(
    index_type,
    static_cast<int32_t>(
        CABINDB_NAMESPACE::BlockBasedTableOptions::kBinarySearch),
...
extern std::vector<std::string> cabindb_kill_exclude_prefixes;

DEFINE_bool(disable_wal, false, "If true, do not write WAL for write.");

DEFINE_uint64(recycle_log_file_num,
              CABINDB_NAMESPACE::Options().recycle_log_file_num,
...
DEFINE_bool(avoid_unnecessary_blocking_io,
            CABINDB_NAMESPACE::Options().avoid_unnecessary_blocking_io,
...
DEFINE_bool(write_dbid_to_manifest,
            CABINDB_NAMESPACE::Options().write_dbid_to_manifest,
            "Write DB_ID to manifest");

DEFINE_bool(avoid_flush_during_recovery,
            CABINDB_NAMESPACE::Options().avoid_flush_during_recovery,
            "Avoid flush during recovery");

DEFINE_uint64(max_write_batch_group_size_bytes,
              CABINDB_NAMESPACE::Options().max_write_batch_group_size_bytes,
              "Max write batch group size");

DEFINE_bool(level_compaction_dynamic_level_bytes,
            CABINDB_NAMESPACE::Options().level_compaction_dynamic_level_bytes,
            "Use dynamic level");
