...
// Database statistics
static std::shared_ptr<CABINDB_NAMESPACE::Statistics> dbstats;
static std::shared_ptr<CABINDB_NAMESPACE::Statistics> dbstats_secondaries;
...
class Stats {
 ...
 public:
  ...
  void Report(const char* name) {
    ...
    fprintf(stdout, "%-12s: Single deleted %" CABINDB_PRIszt " times\n", "",
            single_deletes_);
