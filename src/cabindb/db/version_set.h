...
class VersionStorageInfo {
 public:
  ...
  const CABINDB_NAMESPACE::LevelFilesBrief& LevelFilesBrief(int level) const {
 ...
 private:
  ...
  autovector<CABINDB_NAMESPACE::LevelFilesBrief> level_files_brief_;
  ...
  // If set to true, we will run consistency checks even if CabinDB
...
class VersionSet {
 public:
  ...
  // the lifetime of a CabinDB instance. It reduces number of levels
