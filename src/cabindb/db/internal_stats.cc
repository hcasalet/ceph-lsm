...
static const std::string cabindb_prefix = "cabindb.";
...
const std::string DB::Properties::kNumFilesAtLevelPrefix =
    cabindb_prefix + num_files_at_level_prefix;
const std::string DB::Properties::kCompressionRatioAtLevelPrefix =
    cabindb_prefix + compression_ratio_at_level_prefix;
const std::string DB::Properties::kStats = cabindb_prefix + allstats;
const std::string DB::Properties::kSSTables = cabindb_prefix + sstables;
const std::string DB::Properties::kCFStats = cabindb_prefix + cfstats;
const std::string DB::Properties::kCFStatsNoFileHistogram =
    cabindb_prefix + cfstats_no_file_histogram;
const std::string DB::Properties::kCFFileHistogram =
    cabindb_prefix + cf_file_histogram;
const std::string DB::Properties::kDBStats = cabindb_prefix + dbstats;
const std::string DB::Properties::kLevelStats = cabindb_prefix + levelstats;
const std::string DB::Properties::kNumImmutableMemTable =
    cabindb_prefix + num_immutable_mem_table;
const std::string DB::Properties::kNumImmutableMemTableFlushed =
    cabindb_prefix + num_immutable_mem_table_flushed;
const std::string DB::Properties::kMemTableFlushPending =
    cabindb_prefix + mem_table_flush_pending;
const std::string DB::Properties::kCompactionPending =
    cabindb_prefix + compaction_pending;
const std::string DB::Properties::kNumRunningCompactions =
    cabindb_prefix + num_running_compactions;
const std::string DB::Properties::kNumRunningFlushes =
    cabindb_prefix + num_running_flushes;
const std::string DB::Properties::kBackgroundErrors =
    cabindb_prefix + background_errors;
const std::string DB::Properties::kCurSizeActiveMemTable =
    cabindb_prefix + cur_size_active_mem_table;
const std::string DB::Properties::kCurSizeAllMemTables =
    cabindb_prefix + cur_size_all_mem_tables;
const std::string DB::Properties::kSizeAllMemTables =
    cabindb_prefix + size_all_mem_tables;
const std::string DB::Properties::kNumEntriesActiveMemTable =
    cabindb_prefix + num_entries_active_mem_table;
const std::string DB::Properties::kNumEntriesImmMemTables =
    cabindb_prefix + num_entries_imm_mem_tables;
const std::string DB::Properties::kNumDeletesActiveMemTable =
    cabindb_prefix + num_deletes_active_mem_table;
const std::string DB::Properties::kNumDeletesImmMemTables =
    cabindb_prefix + num_deletes_imm_mem_tables;
const std::string DB::Properties::kEstimateNumKeys =
    cabindb_prefix + estimate_num_keys;
const std::string DB::Properties::kEstimateTableReadersMem =
    cabindb_prefix + estimate_table_readers_mem;
const std::string DB::Properties::kIsFileDeletionsEnabled =
    cabindb_prefix + is_file_deletions_enabled;
const std::string DB::Properties::kNumSnapshots =
    cabindb_prefix + num_snapshots;
const std::string DB::Properties::kOldestSnapshotTime =
    cabindb_prefix + oldest_snapshot_time;
const std::string DB::Properties::kOldestSnapshotSequence =
    cabindb_prefix + oldest_snapshot_sequence;
const std::string DB::Properties::kNumLiveVersions =
    cabindb_prefix + num_live_versions;
const std::string DB::Properties::kCurrentSuperVersionNumber =
    cabindb_prefix + current_version_number;
const std::string DB::Properties::kEstimateLiveDataSize =
    cabindb_prefix + estimate_live_data_size;
const std::string DB::Properties::kMinLogNumberToKeep =
    cabindb_prefix + min_log_number_to_keep_str;
const std::string DB::Properties::kMinObsoleteSstNumberToKeep =
    cabindb_prefix + min_obsolete_sst_number_to_keep_str;
const std::string DB::Properties::kTotalSstFilesSize =
    cabindb_prefix + total_sst_files_size;
const std::string DB::Properties::kLiveSstFilesSize =
    cabindb_prefix + live_sst_files_size;
const std::string DB::Properties::kBaseLevel = cabindb_prefix + base_level_str;
const std::string DB::Properties::kEstimatePendingCompactionBytes =
    cabindb_prefix + estimate_pending_comp_bytes;
const std::string DB::Properties::kAggregatedTableProperties =
    cabindb_prefix + aggregated_table_properties;
const std::string DB::Properties::kAggregatedTablePropertiesAtLevel =
    cabindb_prefix + aggregated_table_properties_at_level;
const std::string DB::Properties::kActualDelayedWriteRate =
    cabindb_prefix + actual_delayed_write_rate;
const std::string DB::Properties::kIsWriteStopped =
    cabindb_prefix + is_write_stopped;
const std::string DB::Properties::kEstimateOldestKeyTime =
    cabindb_prefix + estimate_oldest_key_time;
const std::string DB::Properties::kBlockCacheCapacity =
    cabindb_prefix + block_cache_capacity;
const std::string DB::Properties::kBlockCacheUsage =
    cabindb_prefix + block_cache_usage;
const std::string DB::Properties::kBlockCachePinnedUsage =
    cabindb_prefix + block_cache_pinned_usage;
const std::string DB::Properties::kOptionsStatistics =
    cabindb_prefix + options_statistics;
