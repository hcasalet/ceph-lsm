...
TEST_F(DBRangeDelTest, MaxCompactionBytesCutsOutputFiles) {
  ...
  // https://github.com/facebook/cabindb/issues/1778
...
// NumTableFilesAtLevel() is not supported in CABINDB_LITE
#ifndef CABINDB_LITE
...
TEST_F(DBRangeDelTest, RangeTombstoneEndKeyAsSstableUpperBound) {
...

  {
    ...
    const CABINDB_NAMESPACE::Slice begin = begin_str;
...
TEST_F(DBRangeDelTest, RangeTombstoneWrittenToMinimalSsts) {
  // Adapted from
  // https://github.com/cockroachdb/cockroach/blob/de8b3ea603dd1592d9dc26443c2cc92c356fbc2f/pkg/storage/engine/cabindb_test.go#L1267-L1398.
