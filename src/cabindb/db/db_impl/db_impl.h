...
// While DB is the public interface of CabinDB, and DBImpl is the actual
// class implementing it. It's the entrance of the core CabindB engine.
...
class DBImpl : public DB {
 public:
  ...
  // This is to be used only by internal cabindb classes.
 ...
 private:
  ...
  struct BGFlushArg {
    ...
    // Pointer to a SuperVersionContext object. After flush completes, CabinDB
...
#else
  // IngestExternalFile is not supported in CABINDB_LITE so this function
  // will be no-op
  void WaitForIngestFile() {}
#endif  // CABINDB_LITE
  ...
  // A flag indicating whether the current cabindb database has any
