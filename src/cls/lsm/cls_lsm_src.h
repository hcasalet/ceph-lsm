...
int lsm_get_entries(cls_method_context_t hctx, cls_lsm_get_entries_ret& op_ret, cls_lsm_node_head& node);
int lsm_append_entries(cls_method_context_t hctx, cls_lsm_append_entries_op& op, cls_lsm_node_head& node);
int lsm_compact_node(cls_method_context_t hctx, cls_compact_data_op& op, cls_lsm_node_head& node_head);
